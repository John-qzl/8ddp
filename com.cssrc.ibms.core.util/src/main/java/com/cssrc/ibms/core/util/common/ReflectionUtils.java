...
public class ReflectionUtils
{
        ...
        throws Exception
    {
        ...
        Object target =
            ((AdvisedSupport)ReflectionUtils.getFieldValue(dynamicAdvisedInterceptor, "advised")).getTargetSource()
                .getTarget();
        ...
        throws Exception
    {
        ...
        Object target =
            ((AdvisedSupport)ReflectionUtils.getFieldValue(invocationHandler, "advised")).getTargetSource().getTarget();
        return getTarget(target);
    }
