package com.cssrc.ibms.core.constant.activity;
...
public class BpmConst {
     ...
     * 子流程流程主键key
     */
    public static final String SUBFLOW_BUSINESSKEY="subbusinessKey";
    
    /**
     * 子流程跳转节点
     */
    public static final String BACK_SUBFLOWNODE="backSubFlowNodeKey";
    
    /**
     * 子流程跳转节点
     */
    public static final String BACK_SUBFLOWINSTID="backSubFlowInstId";
	 ...
	 * Rtx消息
	 */
	public static final String MESSAGE_TYPE_RTX="4";
