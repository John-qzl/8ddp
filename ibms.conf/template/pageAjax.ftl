		...
		<#if (showPageSize)>
			<label class="fl">
				...
				<div class="l-bar-group l-bar-selectpagesize">
					<select id="pageSize" name="pageSize" onchange="changePageSizeAjax(this,'${tableIdCode}');" class="select_short">
			...
			<div class="l-bar-group-right">
				<div class="fl">
					<div class="l-bar-button l-bar-btnfirst">
						<#if pageBean.currentPage == 1>
							<button href="javascript:;" onclick="firstAjax(this,'${tableIdCode}')" disabled="disabled" title="首页">
								<span>首页</span>
							</button> 
						<#else>
							<button href="javascript:;" onclick="firstAjax(this,'${tableIdCode}')" title="首页">
								<span>首页</span>
							</button> 
						</#if>
					</div>
				...
				<div class="fl">	
					<div class="l-bar-button l-bar-btnprev">
						<#if pageBean.currentPage == 1>
							<button href="javascript:;" onclick="previousAjax(this,'${tableIdCode}');" disabled="disabled" title="上一页">
								<span>上一页</span>
							</button>
						<#else>
							<button href="javascript:;" onclick="previousAjax(this,'${tableIdCode}');" title="上一页">
								<span>上一页</span>
							</button>
						</#if>
					</div>
				...
				<div class="fl">
					<div class="l-bar-button l-bar-btnnext">
						<#if pageBean.currentPage == pageBean.totalPage>
							<button href="javascript:;" onclick="nextAjax(this,'${tableIdCode}')" disabled="disabled" title="下一页">
								<span>下一页</span>
							</button>
						<#else>
							<button href="javascript:;" onclick="nextAjax(this,'${tableIdCode}')" title="下一页">
								<span>下一页</span>
							</button>
						</#if>
					</div> 
				...
				<div class="fl">
					<div class="l-bar-button l-bar-btnlast">
						<#if pageBean.currentPage == pageBean.totalPage>
							<button href="javascript:;" onclick="lastAjax(this,'${tableIdCode}')" disabled="disabled" title="尾页">
								<span>尾页</span>
							</button>
						<#else>
							<button href="javascript:;" onclick="lastAjax(this,'${tableIdCode}')"  title="尾页">
								<span>尾页</span>
							</button>
						</#if>
					</div>
				...
				<div class="fl">
					<input type="button" id="btnGo" class="btn-go" value="确定" onclick="jumpToAjax(this,'${tableIdCode}');"/>
				</div>
			</div>
		</div>
