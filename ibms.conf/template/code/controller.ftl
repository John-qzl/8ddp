...
import com.ibms.core.annotion.Action;
...
<#if hasIdentity==1>
import com.ibms.oa.service.system.SerialNumberService;
</#if>
<#if flowKey?exists>
import com.ibms.core.util.StringUtil;
import com.ibms.core.util.ContextUtil;
...
public class ${class}Controller extends BaseController
{
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception
	{
		...
		<#elseif (field.valueFrom==3)>
			String ${field.fieldName}_id=serialNumberService.nextId("${field.identity}");
