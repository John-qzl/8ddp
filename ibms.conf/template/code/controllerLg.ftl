...
package com.ibms.${system}.controller.${package};

import java.io.PrintWriter;
import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
import com.ibms.core.page.PageBean;
import com.ibms.core.util.StringUtil;
import com.ibms.core.util.DateUtil;
...
import com.ibms.oa.annotion.Action;
import org.springframework.web.servlet.ModelAndView;
import com.ibms.core.util.UniqueIdUtil;
import com.ibms.core.web.util.RequestUtil;
import com.ibms.core.web.controller.BaseController;
import com.ibms.core.util.BeanUtils;
import com.ibms.core.web.query.QueryFilter;

import com.ibms.${system}.model.${package}.${class};
import com.ibms.${system}.service.${package}.${class}Service;
...
import com.ibms.core.web.ResultMessage;
<#if hasScript==1>
import com.ibms.core.engine.GroovyScriptEngine;
</#if>
<#if hasIdentity==1>
import com.ibms.oa.service.system.IdentityService;
</#if>
<#if flowKey?exists>
import com.ibms.core.util.StringUtil;
import com.ibms.core.api.util.ContextUtil;
import com.ibms.core.bpm.model.ProcessCmd;
import com.ibms.oa.model.bpm.ProcessRun;
import com.ibms.oa.service.bpm.ProcessRunService;
</#if>
/**
 * 对象功能:${comment} 控制器类
 */
...
<#if flowKey?exists>
	...
	public void run(HttpServletRequest request, HttpServletResponse response,${class} ${classVar}) throws Exception
	{
		...
		processCmd.setUserAccount(((SysUser)ContextUtil.getCurrentUser()).getUsername());
		try {
