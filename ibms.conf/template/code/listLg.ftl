...
<%@include file="/jslib/lg/getLg.jsp"%>
	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="groupUI"><a class="link search" id="btnSearch">查询</a></div>
					
					<div class="groupUI"><a class="link add" action="edit.do"><span></span>添加</a></div>
					
					<div class="groupUI"><a class="link update" id="btnUpd" action="edit.do"><span></span>修改</a></div>
					<#if !flowKey?exists>
					
					<div class="groupUI"><a class="link del"  action="del.do">删除</a></div>
					</#if>
				</div>	
			</div>
			<div class="panel-search">
				<form id="searchForm" method="post" action="getList.do">
					<div class="row">
