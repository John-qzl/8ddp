	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a class="link add" href="${ctxPath}/oa/form/formHandler/bizForm.do?formKey=${formKey}">添加</a></div>
				
				
				<div class="group"><a class="link back" href="myList.do">返回</a></div>
			</div>
		</div>
		<#if (conditionFields?size>0) >
			<div class="panel-search">
				<form id="searchForm" method="post" action="${ctxPath}/oa/form/tableTemplate/get.do">
					<div class="row">
	...
	<div class="panel-body">
			<table cellpadding="1" cellspacing="1" class="table-grid table-list">
				...
				<tr class="<#noparse><#if data_index % 2 == 0>odd</#if><#if data_index % 2 == 1>even</#if></#noparse>">
					...
					<td>
						<a href="detail.do?formKey=${formKey}&flowRunId=<#noparse>${data.flowrunid_}</#noparse>&id=<#noparse>${data.</#noparse>${pkField}}" class="link detail">明细</a>
						<a href="${ctxPath}/oa/form/formHandler/bizForm.do?formKey=${formKey}&id=<#noparse>${data.</#noparse>${pkField}}" class="link edit">编辑</a>
						<a href="${ctxPath}/oa/form/formHandler/del.do?formKey=${formKey}&id=<#noparse>${data.</#noparse>${pkField}}" class="link del">删除</a>
					</td>
				</tr>
