...
<#macro genQueryDate field>
		<#switch field.qt>
			<#case "D">
				<input type="text" name="Q_${field.na}_D" readonly="readonly" datefmt="${field.ftm}"  class="wdateTime inputText"  />
			<#break>
			<#case "DL">
				<input type="text" name="Q_${field.na}_DL" readonly="readonly" datefmt="${field.ftm}"  class="wdateTime inputText"  />
			<#break>
			<#case "DG">
				<input type="text" name="Q_${field.na}_DG"  readonly="readonly" datefmt="${field.ftm}" class="wdateTime inputText"   />
			<#break>
			<#case "DR">
				<input type="text" name="Q_begin${field.na}_DL" readonly="readonly" datefmt="${field.ftm}" class="wdateTime inputText"  />
				<span class="label">到:</span>
				<input type="text" name="Q_end${field.na}_DG" readonly="readonly" datefmt="${field.ftm}" class="wdateTime inputText"  />
			<#break>
			<#default>
				<input type="text" name="Q_${field.na}_${field.qt}" datefmt="${field.ftm}" class="inputText"  />
			<#break>
		</#switch>
</#macro>
<#--用户选择器 -->
<#macro genQuerySelector field>
		<#switch field.ct>
			<#case "4"><#--用户单选选择器 -->
				...
				<input type="text" readonly="readonly" class="inputText" name="Q_${field.na}~_SL" id="${field.na}" onclick="__Selector__.selectUser({self:this});">
			<#break>
			<#case "5"><#--角色多选选择器 -->
				<input  type="hidden" name="Q_${field.na}ID_L" id="${field.na}ID">
				<input type="text" readonly="readonly" class="inputText" name="Q_${field.na}~_SL" id="${field.na}" onclick="__Selector__.selectRole({self:this});">
			<#break>
			<#case "6"><#--组织多选选择器 -->
				<input  type="hidden" name="Q_${field.na}ID_L" id="${field.na}ID">
				<input type="text" readonly="readonly" class="inputText" name="Q_${field.na}~_SL" id="${field.na}" onclick="__Selector__.selectOrg({self:this});">
			<#break>
			<#case "7"><#--岗位多选选择器 -->
				<input  type="hidden" name="Q_${field.na}ID_L" id="${field.na}ID">
				<input type="text" readonly="readonly" class="inputText" name="Q_${field.na}~_SL" id="${field.na}" onclick="__Selector__.selectPos({self:this});">
			<#break>
			<#case "8"><#--人员多选选择器 -->
				<input  type="hidden" name="Q_${field.na}ID_L" id="${field.na}ID">
				<input type="text" readonly="readonly" class="inputText" name="Q_${field.na}~_SL" id="${field.na}" onclick="__Selector__.selectUser({self:this});">
