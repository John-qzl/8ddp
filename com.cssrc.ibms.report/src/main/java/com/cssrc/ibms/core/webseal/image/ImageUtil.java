...
public class ImageUtil
{
     ...
     * @param format
     */
    public static void setImage(double[] result, int width, int height, String filepath, String format, int type)
    {
     ...
     * @return
     */
    public static int[][][] getRGBArrayToMatrix(int[] pixels, int width, int height)
    {
        // 已知有3个二维数组组成分别代表RGB
