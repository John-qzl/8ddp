...
public class SysFileService extends BaseService<SysFile> implements
	 ...
	 */
	public String uploadAttach1(MultipartHttpServletRequest request,HttpServletResponse response,ISysUser appUser,long userId,String photoType,String unrealFullName)
			throws IOException, MyException{
		// 附件保存路径
 		String saveType = PropertyUtil.getSaveType();
		String msg="";//返回执行情况
