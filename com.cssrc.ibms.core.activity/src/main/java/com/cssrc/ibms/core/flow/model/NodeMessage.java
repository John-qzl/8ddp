...
public class NodeMessage extends BaseModel implements Cloneable
{
	...
	private List<UserCondition> userConditions = new ArrayList<UserCondition>();
	...
	public void setTemplate(String template) {
   	...
   	public List<UserCondition> getUserConditions() {
		return userConditions;
	}
	public void setUserConditions(List<UserCondition> userConditions) {
	...
	{
		if (!(object instanceof NodeMessage)) 
		{
			return false;
		}
		NodeMessage rhs = (NodeMessage) object;
	...
	public Object clone()
	{
		NodeMessage obj=null;
		try{
			obj=(NodeMessage)super.clone();
