...
/**
 * 对象功能:子表权限 Model对象 开发人员:zhulongchao
 */
public class SubtableRights extends BaseModel implements ISubtableRights {
	// ID
	protected Long id;
	// 流程定义ID
	...
	public boolean equals(Object object) {
		if (!(object instanceof SubtableRights)) {
			return false;
		}
		SubtableRights rhs = (SubtableRights) object;
		return new EqualsBuilder().append(this.id, rhs.id)
				...
				.append(this.parentActDefId, rhs.parentActDefId).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				.append(this.actdefid).append(this.nodeid).append(this.tableid)
				.append(this.permissiontype).append(this.permissionseting)
				.append(this.parentActDefId).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				...
				.append("nodeid", this.nodeid).append("tableid", this.tableid)
				.append("permissiontype", this.permissiontype)
				.append("permissionseting", this.permissionseting)
				.append("parentActDefId", this.parentActDefId).toString();
	}
