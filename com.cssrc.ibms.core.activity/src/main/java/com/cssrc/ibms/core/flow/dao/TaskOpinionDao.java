...
public class TaskOpinionDao extends BaseDao<TaskOpinion>
{
	...
	public List<TaskOpinion> getFormOpinionByActInstId(String actInstId ,boolean isAsc)
	{
		Map params = new HashMap();
		params.put("actInstId", actInstId);
		params.put("isAsc", isAsc);
		return getBySqlKey("getFormOpinionByActInstId", params);
	}
	 ...
	 * @return
	 */
	public TaskOpinion getByInstId(Long actInstId){
		return getUnique("getByInstId", actInstId);
	}
	
	public String getSupInstByActInstId(String actInstId) {
		return (String) getOne("getSupInstByActInstId", actInstId);
	}

	public List<TaskOpinion> getBySuperInstId(Long actInstId){
		return getBySqlKey("getBySuperInstId", actInstId);
	}
     ...
     * @return
     */
    public List<TaskOpinion> getOpinionForReport(Map<String, String> parmas)
    {
        return getBySqlKey("getOpinionForReport", parmas);
    }

    public List<TaskOpinion> getOpinionByActInstId(String actInstId)
    {
        return getBySqlKey("getOpinionByActInstId", actInstId);
    }
}