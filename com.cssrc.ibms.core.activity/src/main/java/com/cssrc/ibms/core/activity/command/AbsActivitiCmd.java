 ...
 * 
 */
public abstract class AbsActivitiCmd implements IProcessCmd
{
    /**
    ...
    public AbsActivitiCmd()
    {
        
    }
    
    public AbsActivitiCmd(String flowKey)
    {
        this.flowKey = flowKey;
    }
    
    public AbsActivitiCmd(String flowKey, boolean skipPreHandler, boolean skipAfterHandler)
    {
        this.flowKey = flowKey;
    ...
    public AbsActivitiCmd(String taskId, String content, Short isAgree)
    {
        this.taskId=taskId;
