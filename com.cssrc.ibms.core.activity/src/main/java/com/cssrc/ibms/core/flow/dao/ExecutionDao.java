...
public class ExecutionDao extends GenericDao<ProcessExecution, String>
{
    ...
    {
        delBySqlKey("delCandidateByProcInstId", executionId);
        delBySqlKey("delById", executionId);
    }
    
    public void delCandidateByProcInstId(String executionId)
    {
        delBySqlKey("delCandidateByProcInstId", executionId);
    }
    ...
    {
        delBySqlKey("delCandidateByProcInstId", procInstId);
        delBySqlKey("delExecutionByProcInstId", procInstId);
    }
    
    public List<ProcessExecution> getByProcInstId(Long procInstId)
    {
    ...
    {
        Map<String, Object> vars = new HashMap<String, Object>();
        vars.put("oldInstId", newInstId);
        vars.put("newInstId", oldInstId);
        this.getBySqlKey("updateBackToSubFlow", vars);
        
    }
    
    public void delCandidateByTaskId(String taskId)
    {
        delBySqlKey("delCandidateByTaskId", taskId);
    }
}
