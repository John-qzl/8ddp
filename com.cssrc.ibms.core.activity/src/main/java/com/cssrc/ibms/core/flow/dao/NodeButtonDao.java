...
@Repository
public class NodeButtonDao extends BaseDao<NodeButton>
{
	@SuppressWarnings("rawtypes")
	@Override
	public Class getEntityClass()
	{
		return NodeButton.class;
	}
	...
	public List<NodeButton> getByDefId(Long defId){
		...
		List<NodeButton> list=this.getBySqlKey("getByDefId", defId);
		return list;
	}
	...
	public List<NodeButton> getByDefNodeId(Long defId,String nodeId){
		...
		List<NodeButton> list=this.getBySqlKey("getByDefNodeId", params);
		return list;
	}
	...
	public List<NodeButton> getByStartForm(Long defId){
		List<NodeButton> list=this.getBySqlKey("getByStartForm", defId);
		return list;
	}
