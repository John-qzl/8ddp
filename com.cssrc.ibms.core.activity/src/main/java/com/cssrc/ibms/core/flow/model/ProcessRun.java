...
public class ProcessRun extends BaseModel  implements Cloneable, IProcessRun{
	...
	// rootBusinessKey
	protected String rootBusinessKey;
	// businessUrl
	...
	//全局流程变量
	 ...
	 //关联实例ID
	 protected Long relRunId = Long.valueOf(0L);
	...
	public Long getRelRunId() {
		if (this.relRunId == null) return Long.valueOf(0L);
		return relRunId;
	}
    ...
    public String getRootBusinessKey()
    {
        return rootBusinessKey;
    }

    public void setRootBusinessKey(String rootBusinessKey)
    {
        this.rootBusinessKey = rootBusinessKey;
    }
}