...
public class TaskSignDataService extends BaseService<TaskSignData>
{
	 ...
	 * @param isAgree
	 */
	public void signVoteTask(String taskId,ProcessCmd processCmd){
		...
		if(taskSignData!=null){
			taskSignData.setIsAgree(processCmd.getVoteAgree());
			taskSignData.setContent(processCmd.getVoteContent());
			//添加审批意见模板code
			taskSignData.setVoteCode(processCmd.getVoteCode());
	...
	public void addSign(String userIds,String taskId, String opinion, String informType) throws Exception{
		...
		if("sequential".equals(multiInstance)){
			...
			for(int i=0;i<userAmount;i++){
				...
				userTaskMap.put(userId, Long.valueOf(-1L));
			}
		...
		bpmRunLogService.addRunLog(processRun.getRunId(), RunLog.OPERATOR_TYPE_SIGN, memo);
	}
