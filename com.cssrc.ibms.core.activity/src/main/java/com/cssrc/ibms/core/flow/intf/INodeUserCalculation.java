 ...
 *
 */
public interface  INodeUserCalculation {
	 ...
	 * @return
	 */
	List<?extends ISysUser> getExecutor(NodeUser bpmNodeUser,CalcVars vars);
	 ...
	 * @return
	 */
	Set<TaskExecutor> getTaskExecutor(NodeUser bpmNodeUser,CalcVars vars);
