 ...
 */
@XmlRootElement(name = "defRights")
@XmlAccessorType(XmlAccessType.NONE)
public class DefRights extends BaseModel implements Cloneable
{
	...
	{
		if (!(object instanceof DefRights)) 
		{
			return false;
		}
		DefRights rhs = (DefRights) object;
