...
public class Button {
	...
	public Integer getParamscript() {
		return paramscript==null?0:paramscript;
	}

	public void setParamscript(Integer paramscript) {
		this.paramscript = paramscript==null?0:paramscript;
	}
