	...
	static {
		try {
			USERTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/user.png"));
			SCRIPTTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/script.png"));
			SERVICETASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/service.png"));
			RECEIVETASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/receive.png"));
			SENDTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/send.png"));
			MANUALTASK_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/manual.png"));
			TIMER_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/timer.png"));
			ERROR_THROW_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/error_throw.png"));
			ERROR_CATCH_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/error_catch.png"));
			CALLACTIVITY_IMAGE = ImageIO
					.read(ReflectUtil
							.getResourceAsStream("com/cssrc/ibms/core/activity/graph/image/call_activity.png"));
