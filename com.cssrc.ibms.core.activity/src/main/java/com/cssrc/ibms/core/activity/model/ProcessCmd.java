...
public class ProcessCmd implements IProcessCmd
{
    ...
    /** 
    * @Fields isBackToExtSub : TODO(是否驳回到子流程) 
    */ 
    private boolean isBackToExtSub = false;
    ...
    /**
     * 是否外部调用。 如值为true 不处理自定义表单数据，不处理表单运行时情况
     */
    private boolean invokeExternal = false;
    
    /**
     * 通知类型。 格式如下1,2,3 1.代表邮件 2.代表手机短信 3.代表站内消息
     */
    private String informType = "";
    
    /**
     * 归档时发送消息给发起人. 格式如下1,2,3 1.代表邮件 2.代表手机短信 3.代表站内消息
     */
    private String informStart = "";
    
    /**
     * isphone :Add by taoguifang at 2012/12/25 此字段仅仅作为标识，标识是手机登录，还是pc登录的
     * 
     * @return
     */
    ...
    private boolean isSaveForm = false;
    ...
    public ProcessCmd(String taskId, String content, Short isAgree)
    {
        this.taskId=taskId;
        this.voteAgree=isAgree;
    ...
    /**
     * 0=弃权 1=同意 2=反对 3=驳回 4=追回 5=会签通过 6=会签不通过 34=提交
     * 
     * @param voteAgree
     */
    ...
    {
        return "ProcessCmd [actDefId=" + actDefId + ", flowKey=" + flowKey + ", taskId=" + taskId + ", runId=" + runId
            + ", destTask=" + destTask + ", isBack=" + isBack + ", isRecover=" + isRecover + ", isOnlyCompleteTask="
            + isOnlyCompleteTask + ", voteAgree=" + voteAgree + ", informType=" + informType + "]";
    }
    ...
    {
        if (this.relRunId == null)
            return Long.valueOf(0L);
        return this.relRunId;
    }
    ...
    public void setSaveForm(boolean isSaveForm)
    {
        this.isSaveForm = isSaveForm;
    }

    public boolean isBackToExtSub()
    {
        return isBackToExtSub;
    }

    public void setBackToExtSub(boolean isBackToExtSub)
    {
        this.isBackToExtSub = isBackToExtSub;
    }
