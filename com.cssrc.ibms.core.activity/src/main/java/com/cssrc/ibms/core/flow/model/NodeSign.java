 ...
 * 开发人员:zhulongchao 
 */
@XmlRootElement(name = "nodeSign")
@XmlAccessorType(XmlAccessType.NONE)
public class NodeSign extends BaseModel implements Cloneable
{
	//表名称
	...
	{
		if (!(object instanceof NodeSign)) 
		{
			return false;
		}
		NodeSign rhs = (NodeSign) object;
