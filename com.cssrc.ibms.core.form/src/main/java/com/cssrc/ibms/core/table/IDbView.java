...
public interface IDbView {
	 ...
	 * @throws Exception 
	 */
	List<String> getViews(String viewName, PagingBean pageBean) throws SQLException, Exception;
	 ...
	 * @return
	 */
	List<TableModel> getViewsByName(String viewName,PagingBean pageBean) throws Exception;
