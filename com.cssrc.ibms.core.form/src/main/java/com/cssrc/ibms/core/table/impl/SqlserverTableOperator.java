...
//		}
	...
	public FormTableIndex getIndex(String tableName, String indexName) {
		...
		List<FormTableIndex> indexes = jdbcTemplate.query(sql,
				new RowMapper<FormTableIndex>() {

					@Override
					public FormTableIndex mapRow(ResultSet rs, int rowNum)
							throws SQLException {
	...
	private String mapTableType(String type) {
		...
		if (type.equalsIgnoreCase("U")){
			tableType = FormTableIndex.TABLE_TYPE_TABLE;
		}else if (type.equalsIgnoreCase("V")) {
			tableType = FormTableIndex.TABLE_TYPE_VIEW;
		}
		return tableType;
	...
	private String mapIndexType(int type) {
		...
		switch (type) {
		case 0:
			indexType = FormTableIndex.INDEX_TYPE_HEAP;
			break;
		case 1:
			indexType = FormTableIndex.INDEX_TYPE_CLUSTERED;
			break;
		case 2:
			indexType = FormTableIndex.INDEX_TYPE_NONCLUSTERED;
			break;
		case 3:
			indexType = FormTableIndex.INDEX_TYPE_XML;
			break;
		case 4:
			indexType = FormTableIndex.INDEX_TYPE_SPATIAL;
			break;
		default:
			break;
		}
	...
	private String mapIndexStatus(int type) {
		...
		switch (type) {
		case 0:
			tableType = FormTableIndex.INDEX_STATUS_VALIDATE;
			break;
		case 1:
			tableType = FormTableIndex.INDEX_STATUS_INVALIDATE;
			break;
		}
		return tableType;
	}
