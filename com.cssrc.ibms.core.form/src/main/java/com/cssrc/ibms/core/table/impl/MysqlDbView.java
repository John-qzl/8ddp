...
import com.cssrc.ibms.core.table.BaseDbView;
...
import com.cssrc.ibms.core.table.colmap.MySqlColumnMap;
...
//	private  static final String  sqlAllView="select view_name from user_views ";
	...
	public List<String> getViews(String viewName) throws SQLException {
		...
		sql +=" AND TABLE_SCHEMA='"+tablespace+"'";//添加项目库名
	 ...
	 */
	@Override
	public List<String> getViews(String viewName,PagingBean pageBean) throws Exception {
		String sql=sqlAllView;
		if(StringUtil.isNotEmpty(viewName)){
			sql+=" AND TABLE_NAME LIKE '"+viewName+"%'";
		}
	...
	@Override
	public List<TableModel> getViewsByName(String viewName, PagingBean pageBean) throws Exception {
