...
public class FormData implements IFormData {
	 ...
	 * @param formTable
	 */
	public FormData(FormTable formTable) {
	 ...
	 * 关系表数据
	 */
	private List<RelTable> relTableList = new ArrayList<RelTable>();
	...
	// 取得关系表数据
	public Map<String, RelTable> getRelTableMap() {
		Map<String, RelTable> map = new HashMap<String, RelTable>();
		for (Iterator<RelTable> it = relTableList.iterator(); it.hasNext();) {
			RelTable tb = it.next();
			map.put(tb.getRelTableName().toLowerCase(), tb);
		}
		return map;
	}
	 ...
	 * @param table
	 */
	public void addRelTable(RelTable table) {
		this.relTableList.add(table);
	}
	...
	public Object getMainField(String key) {
		return this.mainFields.get(key);
	}
	...
	public List<RelTable> getRelTableList() {
		return relTableList;
	}

	public void setRelTableList(List<RelTable> relTableList) {
	...
	@Override
	public void setPkValue(IPkValue pkValue) {
		this.pkValue = (PkValue)pkValue;
	}

	@Override
	public void setSubTableList(List<?extends ISubTable> subTableList) {
		this.subTableList = (List<SubTable>) subTableList;
	}
