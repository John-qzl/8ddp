 ...
 * @Description:该类作为dubbo服务的实现类，不注入的dubbo服务中心， 不同业务系统 需要根据自身业务需求继承该类注入dubbo服务。
 * @author zxg
 * @date 2017年4月27日 下午2:32:40
 * 
 */
public abstract class CommonProviderService implements CommonService, Serializable
{
    ...
    @Resource
    private IFormDialogService formDialogService;
    ...
    /**
     * 1.先考虑从方法formHandlerService.getBpmFormData(xxxx)中获取信息。 2.需要返回属性名词，属性代号，属性值。
     * **/
    public Object getFormDatatest(Map<String, Object> params, Long tableId, String pkValue)
    {
        ...
        {
            formData =
                formHandlerService.getBpmFormData(params, tableId, pkValue, instanceId, actDefId, nodeId, isCopyFlow);
    ...
    /**
     * 1.从"自定义对话框"中获取数据列表信息。 2.需要返回表头，表体数据(keyValue)。
     * */
    ...
    {
        IFormDialog bpmFormDialog = formDialogService.getByAlias(alias);
    ...
    {
        IFormDialog bpmFormDialog = null;
        try
        {
     ...
     */
    @Override
    public Map<String, Object> editData(Long displayId, String pkData, Long userId, String contextPath)
        throws Exception
    {
     ...
     */
    @Override
    public String saveFormData(IFormTable bpmFormTable, Long tableId, int isNeed, String pkData, String formData,
        String formKey)
        throws Exception
    {
        formHandlerService.saveFormData(bpmFormTable, tableId, isNeed, pkData, formData, formKey);
        return pkData;
    }
     ...
     */
    @Override
    public void downAttach(HttpServletRequest request, HttpServletResponse response, String fileId)
        throws IOException
    {
     ...
     */
    @Override
    public String uploadAttach(MultipartHttpServletRequest request, HttpServletResponse response, ISysUser appUser,
        long userId)
        throws Exception
    {
     ...
     */
    @Override
    public String getFormData(Long id, String pk, Long curUserId, String contextPath)
        throws Exception
    {
     ...
     */
    @Override
    public void exportExcel(Long id, String[] exportIds, int exportType, Map<String, Object> params,
        HttpServletResponse response, Long curUserId)
        throws Exception
    {
    ...
    /**
     * @author YangBo
     * @date 2016年12月10日下午4:00:29 mv="report/freport/reportPreView.jsp"
     */
    ...
    {
        IFormDialog formDialog = formDialogService.getByAlias(alias);
        ...
        IFormTable formTable = this.formTableService.getByTableName(tablename);
        return formTable;
    }
    ...
    /**
     * 
     * 用户参与的业务模板中data list 比如用户参与的合同，参与项目或者其他业务表数据， 通过业务表banding的表单。
     * 
     * @param userId 用户id
    ...
    public int getTemplateDataList(ICommonParam commonParam)
    {
        ...
        IDataTemplate dataTemplate = dataTemplateService.getByAlias(template.toString());
	 ...
	 */
    @Override
    public String getDisplay(Long id, Map<String, Object> params, Map<String, Object> queryParams, Long userId)
        throws Exception
    {
