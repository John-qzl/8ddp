<%@page import="com.ibms.core.util.RequestUtil" isErrorPage="true" pageEncoding="UTF-8"%>
<%
	 ...
	 <table width="510" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	    <td height="200" align="center" valign="top" background="<%=basePath%>/styles/default/images/error/error_bg.jpg">
	        ...
	        <tr>
	          <td width="34%" align="right"><img src="<%=basePath%>/styles/${skinStyle}/images/error/error.gif" width="128" height="128"></td>
