...
function initFirstStepTablesTree(){
	...
	var url=__ctx+"/oa/system/jdbcDb/getTables.do?dsName="+dsName;
	url=url.getNewUrl();
...
function validateScript(){
	...
	var url=__ctx+ "/oa/system/sysCustomDisplay/validateScript.do";
	var params={
		dsName:dsName,
		script:script
	};
...
/**
*将从__ctx+"/oa/system/jdbcDb/getTables.do返回的数据转换成ztree SimpleData接受的数据格式
*/
