Namespace.register("com.ibms.oa.system");
/**
 * 表达式计算。
 * var con=com.ibms.oa.system.ConditionExpression();
 * 计算节点
 * con.evaluate(node);
 * 获取结果
 * con.getResult();
 * 清除计算
 * con.clear();
 * @returns {com.ibms.oa.system.ConditionExpression}
 */
com.ibms.oa.system.ConditionExpression = function(){
	{
