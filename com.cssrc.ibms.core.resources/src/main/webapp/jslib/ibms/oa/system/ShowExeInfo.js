...
ShowExeInfo.showRole = function(id){
	ShowExeInfo.showDialog({url: __ctx+'/oa/system/sysRole/getByRoleId.do?roleId='+id});
};

ShowExeInfo.showPos = function(id){
	ShowExeInfo.showDialog({url: __ctx+'/oa/system/position/getByPosId.do?posId='+id});
};

ShowExeInfo.showOrg = function(id){
	ShowExeInfo.showDialog({url: __ctx+'/oa/system/sysOrg/getByLink.do?orgId='+id});
};