 ...
 * 
 */
function bpmDefAuthorizeUserDialog(id,jsonStr){
	var url=__ctx +"/oa/flow/defAuthorize/userDialog.do?num=1";
	var conf={};
	if(objectIsEmpty(id)){
		conf.id="";
	}else{
...
function chooseUser(obj) {
	var tr=$(obj).closest("tr"),
		...
		href = __ctx+"/oa/system/sysUser/get.do?openType=detail&userId=";
