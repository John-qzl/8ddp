...
BpmNodeButton.addOption =function(objOperator,obj,type){
	if(type==obj.operatortype){
		objOperator.append("<option value='"+ obj.operatortype + "' script='"+ obj.script + "' paramscript='"+ obj.paramscript +"' selected>"+obj.text +"</option>");  
	}
	else{
		objOperator.append("<option value='"+ obj.operatortype + "' script='"+ obj.script + "' paramscript='"+ obj.paramscript +"'>"+obj.text +"</option>"); 
	}
};
