...
function loadVarTree(){
	...
	var url=__ctx + "/oa/system/sysWs/getWsParams.do";
...
function saveWebserviceSet(){
	...
	var url = __ctx + "/oa/system/sysWs/save.do";
...
var addMethodNode = function(t,depParse) {
	...
	$.ajax({
		type : "POST",
		url : __ctx + "/oa/flow/nodeWebService/get.do",
		data : params,
		dataType : "json",
...
function loadWsTree() {
	...
	$.ajax({
				type : "POST",
				url : __ctx + "/oa/flow/nodeWebService/getTreeData.do",
				data : {
					'wsdlUrl' : $('#wsdlTxt').val()
				},
				dataType : "json",
