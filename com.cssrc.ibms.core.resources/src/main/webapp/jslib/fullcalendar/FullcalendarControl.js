 ...
 * 
    $(function() {
		var queryDataUrl = __ctx + "/oa/system/sysPlan/listBySubmitAndMonth.do";
		var openPlanUrl = __ctx + "/oa/system/sysPlan/edit.do";
		var queryParams={
...
FullcalendarControl=function(){
	...
	this.openEventSysPlan=function(id,title,url,currentViweDate){
		//var url = __ctx + "/oa/system/sysPlan/edit.do?id="+id
		if(url.indexOf("?") > 0){
