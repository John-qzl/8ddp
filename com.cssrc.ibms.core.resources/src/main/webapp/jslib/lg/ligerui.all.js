...
(function ($)
{
    ...
    l.controls.Dialog.ligerExtend(l.core.Win, {
        ...
        _setImage: function ()
        {
            ...
            if (p.type)
            {
                var alertCss = { paddingLeft: 74, paddingRight: 15, paddingBottom: 30, paddingTop: 30, background: '#fff' };
    ...
    $.ligerDialog.show = function (p)
    {
        ...
        return window.top.$.ligerDialog(p);
    };
    ...
    $.ligerDialog.alert = function (content, title, type, callback, options,width,height)
    {
        content = content || "";
