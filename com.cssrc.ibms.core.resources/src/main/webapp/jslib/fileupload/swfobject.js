function winClose() {
	var a = parent.Ext.getCmp("flexUploadDialogWin");
	if (a.callback) {
...
function getCtxPath() {
	var b = parent.Ext.getCmp("flexUploadDialogWin");
	var a = "0";
	if (b != null) {
		a = b.getCmpByName("fileTypeId").getValue();
	}
	return parent.__ctxPath + "/oa/system/sysFile/fileUpload.do?isFlex=true&flexUserId="
			+ parent.curUserInfo.userId + "&fileTypeId=" + a;
}
function getDeleteFilesPath() {
	return parent.__ctxPath + "/oa/system/sysFile/deleteFile.do?isFlex=true";
}
function getFileCat() {
	var b = parent.Ext.getCmp("flexUploadDialogWin");
	if (b != null) {
		var a = b.getCmpByName("file_cat");
		return a != null ? a.getValue() : "others";
	}
	return "others";
}
