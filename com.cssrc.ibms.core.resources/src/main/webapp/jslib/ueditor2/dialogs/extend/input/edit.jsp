...
<link rel="stylesheet" type="text/css" href="${ctx}/jslib/tree/zTreeStyle.css"/>
...
<script type="text/javascript">	
	...
	$(function() {
		...
		//获取所有数据字典列表
		JsLoader.Load(__ctx + "/js/lg/plugins/catCombo.js","javascript1");
	...
	function getAllRules(){
		var url=__ctx+"/oa/form/formRule/getAllRules.do";
	...
	function getAllSerialnum(){
		var url=__ctx+"/oa/system/serialnumber/getAllIdentity.do";
		$.get(url,function(data){
			if(!data)return;
