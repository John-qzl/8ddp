...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/MathCaltools.js"></script>
...
<script type="text/javascript">
	...
	function getFieldsByTableId(param) {
		...
		$.post(__ctx + '/oa/form/formDef/getAllFieldsByTableId.do',param ,function(data) {
			var json = eval("("+data+")"),
				treeData = [];
