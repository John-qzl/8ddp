       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                '|','pasteinput','tableformat','choosetemplate','opinion','input','groupopinion','taskopinion','flowchart',
                'insertfunction','cutsubtable','pastesubtable','customquery','uncustomquery','numbervalidate','tablefile','help']
        ]
        ...
        ,iframeCssUrl: __ctx +"/styles/default/css/form/form-process.css" //给编辑器内部引入一个css文件
