	...
	me.commands['choosetemplate'] = {
		execCommand : function(cmdName) {
			...
			if(typeof FormDef == 'undefined' || typeof tableId  == 'undefined'){
				...
				showSelectTemplate(__ctx+'/oa/form/formDef/chooseDesignTemplate.do?&isSimple=1');	
			}
			else{
				FormDef.showSelectTemplate(__ctx+'/oa/form/formDef/selectTemplate.do?tableId=' + tableId +"&isSimple=1");
			}
		},
