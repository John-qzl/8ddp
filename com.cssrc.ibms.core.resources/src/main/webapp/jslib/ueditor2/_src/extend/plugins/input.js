...
//					html+='<tr><th>下拉框选项</th><td colspan="3"><span style="color:green;">每行对应一个选项<br /></span><textarea eid="options" cols="50" rows="5"></textarea></td></tr>';
	...
	function getContentHtml(html){
		...
		content.push('<tr class="trScriptID hidden"><th>ID脚本(不显示):</th><td colspan="3"><div><a href="####" onclick="addScript(this)" class="link var" title="常用脚本">常用脚本</a></div><textarea eid="scriptID" prenode="valueFrom" cols="50" rows="5"></textarea></td></tr>');
