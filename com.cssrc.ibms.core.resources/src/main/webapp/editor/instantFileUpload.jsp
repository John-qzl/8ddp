...
<div class="panel" style="border: 1px solid rgb(193, 193, 193);height:99%">
    ...
    <div class="panel-body" style="padding: 0 10px">
        ...
        <p><a href="/dp/temp/常规性检验表.xlsx" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">1.常规验收项目表导入数据模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
        <p><a href="/dp/temp/功能性能验收表.xlsx" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">2.功能性能验收项目表导入数据模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
        <p><a href="/dp/temp/验收报告表.xlsx" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">3.验收报告表模板导入数据模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
    </div>
...
<script type="text/javascript">
    ...
    actionUrl = '${ctx}/model/instance/instantfileUpload.do?acceptancePlanId=' + acceptancePlanId + "&productBatchId=" + productBatchId;
