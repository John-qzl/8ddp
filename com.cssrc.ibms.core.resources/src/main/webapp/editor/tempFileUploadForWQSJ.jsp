...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <hr>
        <p><a href="/dp/temp/武器所检问题表模板.xls" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">1.武器所检问题表模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
