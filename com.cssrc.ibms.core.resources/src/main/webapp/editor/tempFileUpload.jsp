...
<div class="panel" style="border: 1px solid rgb(193, 193, 193);height:99%">
    ...
    <div class="panel-body">
        ...
        <hr>
        <p><a href="/dp/temp/常规性检验表模板.xlsx" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">1.常规性验收项目表模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
        <p><a href="/dp/temp/功能性能验收表模板.xlsx" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">2.功能性能验收项目表模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
        <p><a href="/dp/temp/验收报告表模板.xlsx" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">3.验收报告模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
...
<script type="text/javascript">
    ...
    var extype=getqueryString("extype");
    //    }
    ...
    actionUrl = '${ctx}/dp/form/tempfileUpload.do?maxSize=' + maxSize + "&pid=" + pid + "&fcid=" + fcid + "&type=" + type+"&parentId="+parentId+"&extype="+extype;
        ...
        if (responseText.success == "true") {
           ...
           /*  //存储返回结果
            ...
            if (completeNum == uploadArray.length) {
                ...
                $.ligerDialog.success("文件上传成功！","",function(){
