...
<div class="panel">
	...
	<div class="panel-top">
		<div class="panel-toolbar">
			...
			<div class="group"><a class="link preview" href="####" onclick="javascript:previewpicture()">预览</a></div>
			<div class="group"><a class="link down" href="${ctx}/temp/FlashInstall.exe">Flash插件</a></div>
...
<script type="text/javascript">
	...
	actionUrl='${ctx}/oa/system/sysFile/fileUpload.do?typeId=${typeId}&dataId=${dataId}&fileId=${fileId}&maxSize='+maxSize
			+'&tableId='+getqueryString("tableId")+'&ckResultName='+getqueryString("ckResultName");
	//			console.log(actionUrl);
	//	}else{
	//		actionUrl='${ctx}/oa/system/sysFile/fileUpload.do?fileTypeId=${typeId}&maxSize='+maxSize+'&tableId='+tableId;
	//	}
	//初始化文件上传组件
	...
	function deleteFile(obj){
		...
		//删除文件集合
		uploadArray.splice(delIndex-1, 0);
...
//		var responseText = $.parseJSON(response);
	...
	function previewpicture(){
		...
		var ckResultName = getqueryString("ckResultName") ;
		var params={tableId:tableId ,ckResultName :ckResultName};
		$.post(url,params,function(data){
			if(data.success=="true"){
				DialogUtil.open({
					url:"${ctx}/dp/form/picpreview.do?id="+tableId+'&ckResultName='+getqueryString("ckResultName"),
				...
				$.ligerDialog.error(data.msg,"预览失败");
			}
		});
	};
