...
<div class="panel" style="border: 1px solid rgb(193, 193, 193);height:99%">
    ...
    <div class="panel-body">
        ...
        <p><a href="/dp/temp/型号团队模板.xls" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">1.型号团队模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
    </div>
...
*/
    ...
    actionUrl = '${ctx}/sysUser/import/importModuleTeamFromExcel.do?moduleId='+moduleId;
    //初始化文件上传组件
...
//		var responseText = $.parseJSON(response);
        ...
        if (responseText.success == "true") {
            ...
            //存储返回结果
            returnArray.push(responseText.success);
            completeNum++;
