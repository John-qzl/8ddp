...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <p><a href="/dp/temp/靶场工作组表模板.xls" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">1.人员组表导入模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
...
*/
    actionUrl = '${ctx}/weapon/check/plan/importTeamInfoFromExcelForWeaponCheck.do?';
    //初始化文件上传组件
...
//		var responseText = $.parseJSON(response);
        ...
        if (responseText.success == "true") {
            ...
            //存储返回结果
            returnArray.push(responseText.teamList);
            completeNum++;
