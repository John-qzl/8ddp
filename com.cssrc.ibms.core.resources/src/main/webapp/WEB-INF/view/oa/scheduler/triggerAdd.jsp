...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx }/jslib/ibms/oa/scheduler/JobDialog.js"></script>
		<script type="text/javascript" src="${ctx }/jslib/ibms/oa/scheduler/Trigger.js"></script>
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link back" href="getTriggersByJob.do?jobName=${jobName}">返回</a></div>
				</div>
			</div>
		</div>
		<div class="panel-body">
				<form id="dataForm" method="post" action="addTrigger2.do">
