...
<body>
			...
			<div class="hide-panel">
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link del"  action="delJobLog.do">删除</a></div>
							
							<div class="group"><a class="link back" href="getJobList.do">返回</a></div>
						</div>	
					</div>
					<div class="panel-search">
							<form id="searchForm" method="post" action="getLogList.do?jobName=${jobName }&trigName=${trigName}">
				...
				<div class="panel-body">
					    ...
					    <display:table name="sysJobLogList" id="sysJobLogItem" requestURI="getLogList.do" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
							...
							<a href="delJobLog.do?logId=${sysJobLogItem.logId }" class="link del">删除</a>
							</display:column>
						</display:table>
						<ibms:paging tableId="sysJobLogItem"/>
