		...
		<div class="hide-panel">
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							<div class="group"><a class="link add" href="addTrigger1.do?jobName=${jobName}">添加</a></div>
					    ...
					    <table  cellpadding="1" cellspacing="1"   class="table-grid">
						    ...
						    <%
								...
								for(int i=0;i<list.size();i++)
								{
									...
									String toggleUrl="toggleTriggerRun.do?name=" + trigName ;
									String delTrigger="delTrigger.do?name="+trigName ;
									String logList="getLogList.do?trigName="+trigName+"&jobName="+jobName;
				 			%>
