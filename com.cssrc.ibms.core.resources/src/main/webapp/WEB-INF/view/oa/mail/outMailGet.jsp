			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<c:if test="${outMail.types==1}">
						<div class="group"><a class="link update" href="reply.do?mailId=${outMail.mailId}&isReply=1&outMailSetId=${outMailSetId}">回复</a></div>
						
					</c:if>
					<div class="group">
						<a class="link back" href="list.do?id=${outMailSetId}&types=${outMail.types}">返回</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div style="border:solid 1px #7babcf;margin:2px;padding:4px;">
				...
				<c:forEach items="${attachments}" var="file">
					<div style="font-size:15px;">
						...
						<a href="downLoadAttach.do?fileId=${file.fileId}" id='downLoadAttach'>下载此附件</a>
					</div>
   				</c:forEach>
				<hr>
				<br>
