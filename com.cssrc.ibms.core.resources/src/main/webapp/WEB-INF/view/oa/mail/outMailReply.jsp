		...
		function showResponse(responseText){
			...
			if(obj.isSuccess()){//成功
				$.ligerDialog.success(obj.getMessage(),'成功',function(){
					window.location.href="${ctx}/oa/mail/outMail/list.do?id=${outMailSetId}&types="+type; 		
				});
		    }else{//失败
		...
		<div class="panel">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
				    ...
				    <div class="group"><a class="link back" href="get.do?mailId=${outMail.mailId}&outMailSetId=${outMailSetId}">返回</a></div>
				</div>
			</div>
			</div>
