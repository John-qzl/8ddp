...
<script type="text/javascript"
	src="${ctx}/servlet/ValidJs?form=workTimeSetting"></script>
<script type="text/javascript">
		$(function() {
			initCalendar();
	...
	<div class="panel">
		...
		<div class="panel-body">
			<div class="panel-detail">
				<form id="workTimeSettingForm" method="post" action="save.do">
					<table class="table-detail" cellpadding="0" cellspacing="0"
						border="0">
						<tr>
							<th width="20%">班次名:</th>
							<td><input type="text" id="name" name="name"
								value="${workTimeSetting.name}" class="inputText" /></td>
						</tr>
						<tr>
							<th width="20%">描述:</th>
							<td><input type="text" id="memo" name="memo"
								value="${workTimeSetting.memo}" class="inputText" /></td>
						</tr>
					</table>
					<input type="hidden" name="id" value="${workTimeSetting.id}" /> <br>
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							<div class="group">
								<a class="link add" id="workTimeAdd" href="javascript:add()"><span></span>添加</a>
							</div>
							<div class="l-bar-separator"></div>
							<div class="group">
								<span style="color: red;">时间输入格式，如9时30分，输入09:30</span>
							</div>
						</div>
					</div>

					<table id="workTimeItem" class="table-grid table-list" id="0"
							...
							<c:forEach items="${workTimelist}" var="workTimeItem">
								<tr>
									<td style="text-align: center;"><input
										class="inputText Wdate" type="text" name="startTime"
										style="width: 95%;" value="${workTimeItem.startTime}">
									</td>
									<td style="text-align: center;"><input
										class="inputText Wdate" type="text" name="endTime"
										style="width: 95%;" value="${workTimeItem.endTime}">
									</td>
									<td style="text-align: center;"><input class="inputText"
										type="text" name="desc" style="width: 95%;"
										value="${workTimeItem.memo}"></td>
									<td style="text-align: center;"><a class="link del"
