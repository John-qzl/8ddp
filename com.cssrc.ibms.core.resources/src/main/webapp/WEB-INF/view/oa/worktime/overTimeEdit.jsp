					...
					.confirm(
							...
							function(rtn) {
								if (rtn) {
									...
									window.location.href = "${ctx}/oa/worktime/overTime/list.do";
								}
							});
		} else {
...
<body>
	<div class="panel">
		...
		<div class="panel-body">
			...
			<form id="overTimeForm" method="post" action="save.do">
				<table class="table-detail" cellpadding="0" cellspacing="0"
					border="0">
					<tr>
						<th width="20%">标题:</th>
						<td><input type="text" id="subject" name="subject"
							value="${overTime.subject}" class="inputText" size="40" /></td>
					</tr>
					<tr>
						<th width="20%">用户名称:</th>
						<td>
							<ul>
								<li style="float: left;"><input type="text" id="userName"
									name="userName" readonly="readonly"
									value="${overTime.userName}" validate="{required:true}"
									class="inputText" /> <input type="hidden" id="userId"
									name="userId" value="${overTime.userId}" /></li>
					...
					<tr>
						...
						<td><input type="text" id="startTime" name="startTime"
							...
							class="inputText datetime"
							validate="{date:true,dateRangeEnd:'endTime'}" datetype="datetime" /></td>
					</tr>
					<tr>
						<th width="20%">结束时间:</th>
						<td><input type="text" id="endTime" name="endTime"
							validate="{date:true,dateRangeStart:'startTime'}"
					...
					<tr>
						<th width="20%">描述:</th>
						<td><textarea rows="3" cols="60" name="memo">${overTime.memo}</textarea>
						</td>
					</tr>
