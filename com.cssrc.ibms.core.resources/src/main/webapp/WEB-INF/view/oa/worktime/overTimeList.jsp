...
<body>
	...
	<div class="hide-panel">
		...
		<div class="panel-body">
			    ...
			    <display:table name="overTimeList" id="overTimeItem" requestURI="list.do" 
					...
					<display:column title="管理" media="html" style="width:180px;text-align:center" >
						<a href="del.do?id=${overTimeItem.id}" class="link del">删除</a>
						<a href="edit.do?id=${overTimeItem.id}" class="link edit">编辑</a>
						<a href="get.do?id=${overTimeItem.id}" class="link detail">明细</a>
					</display:column>
				</display:table>
