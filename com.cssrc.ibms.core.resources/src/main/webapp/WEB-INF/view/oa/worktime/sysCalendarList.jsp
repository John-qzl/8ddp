...
<body>
	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link add" href="edit.do"><span></span>添加</a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link update" id="btnUpd" action="edit.do"><span></span>修改</a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link del"  action="del.do"><span></span>删除</a></div>
					<div class="l-bar-separator"></div>
		...
		<div class="panel-body">
			    ...
			    <display:table name="sysCalendarList" id="sysCalendarItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
					...
					<display:column title="管理" media="html" style="width:180px;text-align:center" >
						<a href="edit.do?id=${sysCalendarItem.id}" class="link edit">编辑</a>
						<c:if test="${sysCalendarItem.isDefault==0}">
							<a href="setDefault.do?id=${sysCalendarItem.id}" class="link detail">设置默认</a>
							<a href="del.do?id=${sysCalendarItem.id}" class="link del">删除</a>
						</c:if>
						<!--<a href="get.do?id=${sysCalendarItem.id}" class="link detail">明细</a>-->
					</display:column>
				</display:table>
