...
<body>
	...
	<div class="panel">
			...
			<div class="panel-top">
				...
				<div class="panel-search">
					<form id="searchForm" method="post" action="list.do">
						<ul class="row">
							<li><span class="label">工作日历名称:</span><input type="text"
								name="Q_calendarName_SL" class="inputText"
								value="${param['Q_calendarName_SL']}" /></li>
							<li><span class="label">被分配人名称:</span><input type="text"
								name="Q_assignUserName_SL" class="inputText"
								value="${param['Q_assignUserName_SL']}" /></li>
		...
		<div class="panel-body">
			...
			<display:table name="calendarAssignList" id="calendarAssignItem"
				requestURI="list.do" sort="external" cellpadding="1" cellspacing="1"
				class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
					<input type="checkbox" class="pk" name="id"
						value="${calendarAssignItem.id}">
				</display:column>
				<display:column title="使用工作日历" sortable="true"
					sortName="canlendarId">
				...
				<display:column title="管理" media="html"
					...
					<a href="del.do?id=${calendarAssignItem.id}" class="link del">删除</a>
					<a href="get.do?id=${calendarAssignItem.id}" class="link detail">明细</a>
				</display:column>
			</display:table>
