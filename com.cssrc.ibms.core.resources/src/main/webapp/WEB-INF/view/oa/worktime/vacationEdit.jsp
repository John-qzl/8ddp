...
<body>
	<div class="panel">
		...
		<div class="panel-body">
			<form id="vacationForm" method="post" action="save.do">
				<table class="table-detail" cellpadding="0" cellspacing="0"
					border="0">
					<tr>
						<th width="20%">假日名称:</th>
						<td><input type="text" id="name" name="name"
							value="${vacation.name}" validate="{required:true}"
							class="inputText" /></td>
					</tr>
					<tr>
						<th width="20%">年份:</th>
					...
					<tr>
						...
						<td><input type="text" id="startTime" name="statTime"
							...
							class="inputText date"
							validate="{date:true,dateRangeStart:'endTime'}" /></td>
					</tr>
					<tr>
						<th width="20%">结束时间:</th>
						<td><input type="text" id="endTime" name="endTime"
							...
							class="inputText date"
							validate="{date:true,dateRangeEnd:'startTime'}" /></td>
					</tr>
				</table>
