                ...
                <table class="layui-table">
                  <tbody>
                    <tr>
                      ...
                      <td><input id="id"  name="id" type="text" value="${id}"  onblur="checkFormid()"/><span id="msg" /></td>
                    </tr>
                    <tr>
                      <td><span>检查表名称：</span></td>
                      <td><input id="name" name="name" type="text" value="${name}" onblur="checkFormName()"/><span id="warmMsg" /></td>
                    </tr>
                    <tr>
                      <td><span>签署：</span></td>
                      <td id="3">
