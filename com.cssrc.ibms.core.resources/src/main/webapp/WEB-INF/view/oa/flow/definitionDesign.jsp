...
<%
	...
	// 在flex中保存，发布流程的请求地址
	String postUrl = basePath + "/oa/flow/definition/flexDefSave.do";
	String flowKeyGetUrl = basePath+"/oa/flow/definition/getFlowKey.do";
	String flowListGetUrl = basePath+"/oa/flow/definition/getFlowListByTypeId.do";
	...
	if(defIdObj != null && !defIdObj.toString().equals("0")){
		...
		loadDateUrl = basePath + "/oa/flow/definition/flexGet.do?defId=" + defId;
	}
%>
  ...
  <style type="text/css" media="screen"> 
	...
	#flashContent { display:none; }
       ...
       <script type="text/javascript" src="<%=basePath%>/media/swf/flow/swfobject.js"></script>
       <script type="text/javascript">
	       var swfVersionStr = "10.0.0";
	       var xiSwfUrlStr = "<%=basePath%>/media/swf/flow/playerProductInstall.swf";
	       var flashvars = {};
	       var params = {};
	       params.quality = "high";
	       ...
	       swfobject.embedSWF("<%=basePath%>/media/swf/flow/bpmeditor.swf", "flashContent", 
  ...
  <div id="flashContent">
		...
		<script type="text/javascript"> 
			...
			document.write("<a href='http://www.adobe.com/go/getflashplayer'><img src='http://ww.adobe.com/images/shared/download_buttons/get_flash_player.gif' alt='Get Adobe Flash player'/></a>" ); 
		</script> 
   </div>
	   	
<noscript>
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="bpmeditor">
        <param name="movie" value="<%=basePath%>/media/swf/flow/bpmeditor.swf" />
        ...
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="<%=basePath%>/media/swf/flow/bpmeditor.swf" width="100%" height="80%">
            <param name="quality" value="high" />
            <param name="bgcolor" value="#ffffff" />
            <param name="allowScriptAccess" value="sameDomain" />
            <param name="allowFullScreen" value="true" />
