	...
	<head>
		...
		<script type="text/javascript">
			...
			function saveTaskAssignee(){
				...
				$.post('${ctx}/oa/flow/task/setAssignee.do',params,function(data){
		...
		<div class="panel-top">
		   <div class="tbar-title">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link save" id="btnSearch" onclick="saveTaskAssignee()">保存</a></div>
					
					<div class="group"><a class="link close" onclick="javasrcipt:dialog.close()">关闭</a></div>
			    </div>
			</div>
		</div>
			...
			<form id="taskForm">
					<table class="table-detail">
						...
						<tr>
							...
							<td>
								<input name="informType" type="checkbox" value="3" checked="checked">内部消息 &nbsp;
								<%--<input name="informType" type="checkbox" value="1" checked="checked">手机短信 &nbsp;
								--%>
								<input name="informType" type="checkbox" value="2" checked="checked"> 邮件
							</td>
						</tr>
					</table>
