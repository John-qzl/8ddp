...
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/BpmNodeRule.js"></script>
	...
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/ConditionScriptEditDialog.js"></script>
...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" href="javascript:;"></span>确定</a></div>
				
				<div class="group"><a class="link add" onclick="addAgent()" href="javascript:;">添加</a></div>
	...
	<div class="panel-body">
		<form id="agentConditionForm" method="post" action="save.do">
				...
				<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
					<tr>
						...
						<td>
							...
							<a href="javascript:;" class="button" onclick="selectAgent(this);"><span class="chosen">选 择...</span></a>
						</td>
					</tr>
				</table>
