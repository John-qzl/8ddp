...
<f:link href="from-jsp.css"></f:link>
		...
		<script type="text/javascript">
    			var catKey="${CAT_FLOW}";
     			...
     			leftClickUrl= __ctx+'/oa/flow/task/pendingMattersList.do';
      	...
      	<div id="defLayout" >
            <div position="left" title="流程分类" style="overflow: auto;float:left;width:100%;">
            	<div class="tree-toolbar">
					<span class="toolBar">
						<div class="group"><a class="link reload" id="treeFresh" href="javascript:globalType.loadGlobalTree();"  onclick="javascript:globalType.loadGlobalTree();" title="刷新">刷新</a></div>
            ...
            <div position="center" >
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/oa/flow/task/pendingMattersList.do"></iframe>
            </div>
        </div>
    </body>
</html>
