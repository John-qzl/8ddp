...
<head>
	...
	<script type="text/javascript">
		...
		function delegate(){
			...
			if(!frm.valid()){
				$('textarea[name="memo"]').css('border','1px red solid');
...
<div class="panel">
	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" href="####">分配任务</a></div>
	...
	<div class="panel-body">
		<form id="bpmTaskExeForm" method="post" action="assignSave.do">
			...
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<th>转办原因: <span class="required">*</span></th>
					<td>
