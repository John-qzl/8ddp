...
<script type="text/javascript">
	//导出流程日志数据
	function exportData(){
		var url = __ctx + '/oa/flow/runLog/exportData.do';
...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<c:if test="${runId>0}">
						<div class="group"><a class="link back" onclick="javascript:history.back()">返回</a></div>
					</c:if>
				</div>	
			</div>
			<c:if test="${runId==0}">
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmRunLogList" id="bpmRunLogItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
					  	<input type="checkbox" class="pk" name="id" value="${bpmRunLogItem.id}">
				</display:column>
				<display:column  title="流程标题"  style="width:240px;" sortable="true" sortName="processSubject">
					<c:choose>
				...
				<display:column title="操作类型" sortable="true" style="width:100px;" sortName="operatortype">
					<c:choose>
				...
				<display:column property="memo" title="备注" style="width:300px;" sortable="true" sortName="memo" maxLength="30"></display:column>
				<display:column title="管理" media="html" style="width:80px">
					<%-- <a href="del.do?id=${bpmRunLogItem.id}" class="link del">删除</a> --%>								
					<a href="get.do?id=${bpmRunLogItem.id}" class="link detail">明细</a>
				</display:column>
			</display:table>
			<ibms:paging tableId="bpmRunLogItem"/>
