...
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/NodeSql/BpmNodeSqlService.js"></script>
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/NodeSql/EditController.js"></script>
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/NodeSql/sqlUtil.js"></script>
	<script type="text/javascript">
		...
		function closeWin(){
			if(dialog){//弹出框打开
				...
				window.location.href="list.do?defId=${param.defId}";
			}
		}
		...
		<div class="panel">
			<div class="panel-top">
				...
				<div class="panel-toolbar">
					<div class="toolBar">
						<div class="group">
							<a class="link save" ng-click="save()">保存</a>
						</div>
						<div class="group">
							<a class="link back" href="javaScript:closeWin()">返回</a>
						</div>
					</div>
				</div>
			</div>
