...
<head>
	...
	var dialog = frameElement.dialog; //调用页面的dialog对象(ligerui对象)
		...
		function callBack(rtn) {
			...
			$.post(__ctx+"/oa/flow/taskExe/cancelBat.do",params,function(msg){
		...
		function save(){
			var rtn=$("#taskExeForm").form().valid();
			if(!rtn) return;
...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" href="javascript:;">取消</a></div>
	...
	<div class="panel-body">
		<form id="taskExeForm" method="post" >
