			...
			<div class="panel-top">
				...
				<div class="panel-toolbar">
					<div class="toolBar">
						...
						<div class="group"><a class="link close" onclick="window.close()" href="####">关闭</a></div>
					</div>
				</div>
			</div>
		</div>
