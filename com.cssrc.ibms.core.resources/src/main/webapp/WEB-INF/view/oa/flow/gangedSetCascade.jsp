...
<title>级联设置</title>
<f:link href="jquery/plugins/token-input-normal.css" ></f:link>
...
<script type="text/javascript">
	...
	//初始化
	function init(){
		var cascadeSet = dialog.get("data");
	...
	function saveCascadeSet(){
		...
		if(reduceSet.length==0){
			$.ligerDialog.warn('减少的选项至少需要设置一条记录','提示');
			return;
		}		
		obj.guid = guid;
...
<body>
	...
	<div position="bottom"  class="bottom" style="height:50px;" >
		...
		<a href="####" class="button" style="margin-left:10px;"  onclick="dialog.close()"><span class="icon cancel" ></span><span class="cance" >取消</span></a>
	</div>
</body>
</html>
