...
<body>
	...
	<div class="panel">
		...
		<div class="panel-body">
	    	<display:table name="bpmProCopytoList" id="bpmProCopytoItem" requestURI="getCopyUserByInstId.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
			...
			<ibms:paging tableId="bpmProCopytoItem"></ibms:paging>
		</div>
	</div>
</body>
</html>
