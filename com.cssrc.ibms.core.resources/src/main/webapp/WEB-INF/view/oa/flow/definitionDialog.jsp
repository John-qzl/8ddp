    ...
    <head>
        ...
        <script type="text/javascript">
        		...
        		var globalType=new GlobalType(catKey,"glTypeTree",
       				{
        			onClick:onClick,
        			//url:'${ctx}/oa/system/globalType/getByCatKeyForBpm.do',
        			expandByDepth:1
        			});
                ...
                $(function (){
                	...
                	var url="${ctx}/oa/flow/definition/selector.do?isSingle={0}&validStatus={1}&showAll={2}";
            	...
            	function onClick(treeNode){
            		...
            		var url="${ctx}/oa/flow/definition/selector.do?isSingle={0}&validStatus={1}&showAll={2}&typeId={3}";
    ...
    <body>
      	<div id="defLayout" >            
            ...
            <c:if test="${param.isSingle==false}">
				<div   position="right" title="   <a onclick='javascript:dellAll();' class='link del'>清空 </a><input type='text' class='quick-find' placeholder='查找'/> " style="overflow-y: auto;">
