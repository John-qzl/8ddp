...
<script type="text/javascript" src="${ctx }/jslib/ibms/oa/bpm/VarsWindow.js"></script> 
...
<div class="panel"> 
	<div class="panel-container">
		...
		<%-- 	<div class="panel-search">
					<form id="searchForm" method="post" action="list.do?defId=${defId}&actDefId=${actDefId}&actDeployId=${actDeployId }">
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmDefVarList" id="bpmDefVarItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
				...
				<display:column title="管理" media="html" style="width:180px;text-align:center">
					<%-- <a  href="del.do?varId=${bpmDefVarItem.varId}" class="link del">删除</a>
					<a href="get.do?varId=${bpmDefVarItem.varId}&actDefId=${actDefId}" class="link detail">明细</a> --%>
