...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/form/nodeUserSelectorJS.js" ></script>
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/form/SelectorInit.js"></script>
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/BpmDefinitionConditionEdit.js"></script>
