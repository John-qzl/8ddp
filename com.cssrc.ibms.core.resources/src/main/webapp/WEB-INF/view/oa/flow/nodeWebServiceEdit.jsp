...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/BpmNodeWebServiceEdit.js"></script>
<script type="text/javascript" src="${ctx}/jslib/jquery/plugins/jquery.dragspan.js"></script>
</head>
<body>
	<div class="panel">
		<div class="panel-top">
		...
		<div id="webLayout" class="panel-body">
			...
			<div position="center" title="webservice设置" style="overflow: auto;">
				...
				<div>
					<form id="bpmNodeWebServiceForm" method="post" action="save.do">
