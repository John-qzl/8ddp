...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/SelectUtil.js" ></script>
	...
	function userDetail(userid){
		var url = "${ctx}/oa/system/sysUser/get.do?canReturn=2&userId="+userid;
		url = url.getNewUrl();
		...
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.do">
					...
					<li>
						<span class="label" title="转办(代理)类型:">转办(代理)类型:</span>
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmTaskExeList" id="bpmTaskExeItem" requestURI="accordingMattersList.do" cellpadding="1" cellspacing="1"  class="table-grid">
				...
				<display:column  title="请求标题" sortable="true" sortName="subject">
					<a href="${ctx}/oa/flow/processRun/get.do?runId=${bpmTaskExeItem.runId}" >${f:subString(bpmTaskExeItem.subject)}</a>
				</display:column>
