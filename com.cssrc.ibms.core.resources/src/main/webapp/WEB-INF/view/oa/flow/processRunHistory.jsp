			...
			<div class="panel">
				<div class="panel-top">
					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="history.do">
								<ul class="row plat-row">
								<li>
									<span class="label" title="流程定义名称:">流程定义名称:</span><input type="text" name="Q_processName_SL"  class="inputText" value="${param['Q_processName_SL']}"/>
								</li>
								<li>
									<span class="label" title="流程实例标题:">流程实例标题:</span><input type="text" name="Q_subject_SL"  class="inputText" value="${param['Q_subject_SL']}"/>
								</li>
								<li>	
				...
				<div class="panel-body">
					    ...
					    <display:table name="processRunList" id="processRunItem" requestURI="history.do" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:50px;text-align:center" class="rowOps">
								<f:a alias="delHistory" href="del.do?runId=${processRunItem.runId}" css="link del">删除</f:a>
								...
								<a href="${ctx}/oa/flow/proCopyto/list.do?runId=${processRunItem.runId}" class="link copyTo">抄送转发</a>
							</display:column>
						</display:table>
