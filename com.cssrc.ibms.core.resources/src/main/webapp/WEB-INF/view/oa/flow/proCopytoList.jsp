...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link back" href="${ctx}/oa/flow/processRun/history.do">返回</a></div>
				</div>	
			</div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmProCopytoList" id="bpmProCopytoItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:180px;line-height:21px;">
					<a class="link del" href="del.do?copyId=${bpmProCopytoItem.copyId}">删除</a>
				</display:column>
			</display:table>
