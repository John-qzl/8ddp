...
<head>
    ...
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/SignRuleWindow.js" ></script>
    ...
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/ForkConditionWindow.js" ></script>
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/FlowEventWindow.js" ></script>
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/FlowForkJoinWindow.js" ></script>
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/FlowMessageWindow.js" ></script>
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/FlowWebServiceWindow.js" ></script>
    ...
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/InformTypeWindow.js" ></script>
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/FlowSetWindow.js" ></script>
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/BpmNodeSqlWindow.js" ></script>
    <script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/NodeUserlabelWindow.js" ></script>
    ...
    <script type="text/javascript">
            ...
            function clickHandler(itemId){
            	...
            	if(itemId=="flowVote" && type=="multiUserTask"){
            		...
            		FlowSetWindow({nodeId:activitiId,defId:defId,actDefId:actDefId,returnUrl:returnUrl});
            	}else if(itemId=="nodeSql"){ //节点sql设置
            		BpmNodeSqlWindow({nodeId:activitiId,actDefId:actDefId});
            	}else if(itemId=="userlabel"){
            		NodeUserlabelWindow({nodeId:activitiId,actDefId:actDefId});
            	}
