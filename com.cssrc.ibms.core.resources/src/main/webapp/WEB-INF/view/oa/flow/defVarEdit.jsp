...
<script type="text/javascript" src="${ctx}/servlet/ValidJs?form=bpmDefVar"></script>
	...
	function save(){
		 var rtn=$("#bpmDefVarForm").valid();
   		 if(!rtn) return;
		 var url=__ctx+ "/oa/flow/defVar/save.do";
...
<body>
    <div class="panel">
		<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link del" onclick="dialog.get('sucCall')();dialog.close()">关闭</a></div>
		...
		<div class="panel-body">
				...
				<form id="bpmDefVarForm" method="post" action="save.do">
