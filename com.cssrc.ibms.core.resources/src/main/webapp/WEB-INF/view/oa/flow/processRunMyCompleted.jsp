...
<html>
    <head>
        ...
        <script type="text/javascript">
    			var catKey="${CAT_FLOW}";
     			var glTypeTreeUrl = __ctx+'/oa/system/globalType/getByCatKeyForMyCompleted.do',
     			leftClickUrl= __ctx+'/oa/flow/processRun/myCompletedList.do'
         </script> 
...
<f:link href="from-jsp.css"></f:link>
    ...
    <body>
      	<div id="defLayout" >
            ...
            <div position="center">
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/oa/flow/processRun/myCompletedList.do?porIndex=${porIndex}&tabIndex=${tabIndex}"></iframe>
            </div>
        </div>
    </body>
</html>
