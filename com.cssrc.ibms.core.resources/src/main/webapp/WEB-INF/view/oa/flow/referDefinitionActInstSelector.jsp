	...
	<div class="panel">
			<div class="panel-top">
				...
				<div class="panel-toolbar">
						<div class="group">
							<a class="link search"  onclick="onSearch()" id="btnSearch">查询</a>
						</div>
				...
				<div class="panel-search">
					<form id="searchForm" method="post" action="actInstSelector.do">
						<div class="row">
			...
			<div class="panel-body">
				...
				<display:table name="processRunList" id="processRunItem" requestURI="actInstSelector.do" sort="external" cellpadding="1"
					...
					<display:column title="请求标题" sortable="true" sortName="subject" style="text-align:left">
						<a name="processDetail" onclick="showDetail(this)" href="####"  action="${ctx}/oa/flow/processRun/info.do?link=1&runId=${processRunItem.runId}" title="${processRunItem.subject}">${f:subString(processRunItem.subject)}</a>
					</display:column>
