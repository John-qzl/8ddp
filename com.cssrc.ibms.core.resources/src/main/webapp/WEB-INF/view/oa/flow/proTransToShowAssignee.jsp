	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link back" href="${ctx}/oa/flow/proTransTo/mattersList.do">返回</a></div>
				</div>	
			</div>
		</div>
		</div>
		    ...
		    <display:table name="bpmProTransToAssigneeList" id="bpmProTransToAssigneeItem" cellpadding="1" cellspacing="1"  class="table-grid">
				...
				<display:column title="管理" media="html" style="width:150px">
					<c:if test="${not empty bpmProTransToAssigneeItem.parentTaskId}">
						<a href="####" onclick="cancel('${bpmProTransToAssigneeItem.parentTaskId}','${bpmProTransToAssigneeItem.userId}')" class="link cancel">取消流转</a>
					</c:if>
				</display:column>
			</display:table>
