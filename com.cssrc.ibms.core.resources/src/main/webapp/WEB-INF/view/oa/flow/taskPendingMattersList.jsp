...
function batOperator(operator){
	...
	function exportExcel(){
		...
		if(aryId.length==0){
			...
			url="${ctx}/oa/flow/task/exportAllPendingMatters.do?"+url.split("?")[1];
			...
			var val=tasks.join(",,");
			var headersvalue="序号,事项名称,流程名称,创 建 人,创建时间,状态,待办类型";
			var fileName="已选待办任务";
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><f:a alias="batchApproval" css="link save" id="btnApprove" href="####" showNoRight="false" onclick="batOperator('approve');">批量审批</f:a></div>
					<div class="group"><a onclick="exportExcel()"  class="link export">导出</a></div>
				</div>	
			</div>
			<div class="panel-search" >
				<form id="searchForm" method="post" action="pendingMattersList.do?porIndex=${porIndex}&tabIndex=${tabIndex}">
