...
function exportExcel(){
	...
	if(aryId.length==0){
		...
		var url="${ctx}/oa/flow/processRun/downloadAllCompletedMattersList.do";
		...
		var val=tasks.join(",,");
		var headersvalue="序号,请求标题,流程名称,创建人,创建时间,结束时间,持续时间,状态";
		var fileName="已选办结任务";
	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
					<form id="searchForm" method="post" action="completedMattersList.do">
		...
		<div class="panel-body">
		    ...
		    <display:table name="processRunList" id="processRunItem" requestURI="completedMattersList.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column  titleKey="请求标题" sortable="true" sortName="subject" style="text-align:left">
						<a name="processDetail" onclick="showDetail(this)" href="#${processRunItem.runId}"  action="info.do?prePage=completedMatter&link=1&runId=${processRunItem.runId}" title='${processRunItem.subject}' >${processRunItem.subject}</a>
				</display:column>
