...
<head>
	...
	<script type="text/javascript">
		...
		function delegate(){
			...
			if(!frm.valid()) return;
			$.ligerDialog.confirm('确认转发操作吗?','提示',function(rtn){
				if(!rtn) return;
...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" href="####">转发</a></div>
	...
	<div class="panel-body">
		<form id="bpmTaskExeForm" method="post" action="finishDivert.do">
