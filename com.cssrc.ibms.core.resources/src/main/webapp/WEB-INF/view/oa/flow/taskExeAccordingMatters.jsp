...
<html>
	        ...
	        var catKey="${CAT_FLOW}";
	   		...
	   		function getClickUrl(treeNode){
	   			if($.isEmpty(treeNode.parentId) || treeNode.parentId == 0 ){
	   				return "${ctx}/oa/flow/taskExe/accordingMattersList.do"
	   			}
	   			//else if(treeNode.isLeaf==1){
	   				//不存在三级列表  此处treeNode.isLeaf为null
	   				//return "${ctx}/oa/flow/userTask/accordingMattersList.do?defId="+treeNode.typeId;
	   			//}
	   			else{
	   				return "${ctx}/oa/flow/taskExe/accordingMattersList.do?nodePath="+treeNode.nodePath;
	   			}
	   		}
        </script> 
    ...
    <body>
      	<div id="defLayout" >
            ...
            <div position="center">														  
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/oa/flow/taskExe/accordingMattersList.do"></iframe>
            </div>
        </div>
    </body>
</html>
