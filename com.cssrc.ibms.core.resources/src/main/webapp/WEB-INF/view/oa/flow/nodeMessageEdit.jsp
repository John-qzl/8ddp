...
<head>
	...
	<f:link href="jquery/plugins/token-input-facebook.css" ></f:link>
	<script type="text/javascript" src="${ctx}/jslib/jquery/plugins/jquery.tokeninput.js"></script>
	...
	<script type="text/javascript" src="${ctx}/jslib/ckeditor/ckeditor_sysTemp.js"></script>
	...
	<script type="text/javascript">
		...
		function getTokensFromConditions(conds){
	     ...
	     function save(){
    		 ...
    		 if(!rtn) return;
    		 var url=__ctx+ "/oa/flow/nodeMessage/save.do";
		...
		function receiverSetting(type){
			...
			var url = __ctx+"/oa/flow/nodeMessage/receiverSetting.do?actDefId="+actDefId+"&nodeId="+nodeId+"&type="+type;
			url=url.getNewUrl();
		...
		function reloadToken(type){
			var actDefId=$("#actDefId").val();
			var nodeId = $("#nodeId").val();
			var url = __ctx+"/oa/flow/nodeMessage/getReceiverUserCondition.do";
		 	var param = {
				 	actDefId:actDefId,
				 	nodeId:nodeId,
				 	receiverType:type
...
<body>
		...
		<form id="bpmNodeMessageForm" method="post" action="save.do">
			<div class="panel-detail">
		          ...
		          <div class="foldBox">
					...
					-->
					<input type="hidden" id="id" name="id" value="${requestScope.id}"  class="inputText"/>				
