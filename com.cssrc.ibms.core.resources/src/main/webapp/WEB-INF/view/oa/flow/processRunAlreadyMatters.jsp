...
<html>
    <head>
        ...
        <script type="text/javascript">
   			var catKey="${CAT_FLOW}";
   			var glTypeTreeUrl = __ctx+'/oa/system/globalType/getByCatKeyForAlready.do';
       		function getClickUrl(treeNode){
       			if($.isEmpty(treeNode.parentId) || treeNode.parentId == 0 ){
       				return "${ctx}/oa/flow/processRun/alreadyMattersList.do"
       			}else if(treeNode.isLeaf==1){
       				return "${ctx}/oa/flow/userTask/alreadyMattersList.do?defId="+treeNode.typeId;
       			}else{
       				return "${ctx}/oa/flow/processRun/alreadyMattersList.do?nodePath="+treeNode.nodePath;
       			}
       		}
         </script> 
    ...
    <body>
      	<div id="defLayout" >
            ...
            <div position="center">
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/oa/flow/processRun/alreadyMattersList.do"></iframe>
            </div>
        </div>
    </body>
</html>
