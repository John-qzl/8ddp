	...
	<div class="panel">           
		 <div class="panel-container">
			...
			<div class="panel-body">
				    <display:table name="bpmDefinitionList" id="bpmDefinitionItem" requestURI="versions.do"  sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
						...
						<display:column title="管理" media="html" style="width:220px;">
							<a href="del.do?defId=${bpmDefinitionItem.defId}&isOnlyVersion=true" class="link del" title="删除">删除</a>
							<a href="design.do?defId=${bpmDefinitionItem.defId}" target="_blank" class="link flowDesign" title="在线流程设计">查看设计</a>
							<a href="detail.do?defId=${bpmDefinitionItem.defId}&defIdForReturn=${bpmDefinition.defId}" class="link detail" title="在线流程设计">明细</a>
						</display:column>
					</display:table>
