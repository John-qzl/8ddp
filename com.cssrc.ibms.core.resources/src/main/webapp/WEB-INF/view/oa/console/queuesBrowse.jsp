	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link search" id="btnSearch">刷新</a></div>
					
			        <div class="group"><a class="link back" href="list.do">返回</a></div>
				</div>	
			</div>
			<form id="searchForm" method="post" action="browse.do">
		...
		<div class="panel-body">
		    ...
		    <display:table name="browseList" id="item" requestURI="browse.do" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="name" value="${item.JMSMessageID}">
				</display:column>
				<display:column property="JMSMessageID" title="消息ID"  href="message.do?JMSDestination=${JMSDestination}&"  paramId="id" paramProperty="JMSMessageID"  style="width:280px;"  maxLength="50">
				</display:column>
