...
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/util/tableHeadFix.js"></script>
	...
	<script type="text/javascript">
		...
		function handNextClick(){
			...
			$.get("isTableNameExternalExisted.do",parameter, function(data) {
				if(data=="true"){
		...
		function searchTables(){
			...
			var url=__ctx +"/oa/form/formTable/getTableList.do";
		...
		function sysDatasourceMgr(){
			var url=__ctx + "/oa/system/sysDataSource/list.do";
...
<div class="panel">
		...
		<div class="panel-body">
				<form id="scriptForm" method="post" action="defExtTable2.do">
