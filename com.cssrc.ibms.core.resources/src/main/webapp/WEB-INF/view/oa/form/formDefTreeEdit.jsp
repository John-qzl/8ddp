...
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/formDefTree/EditController.js"></script>
	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group" ng-if="prop.id"><a class="link search" target="_blank" href="show_${param.formKey}.do">预览</a></div>
				<div class="group"><a class="link back" href="javaScript:dialog.close()">关闭</a></div>
			</div>
		</div>
	</div>
