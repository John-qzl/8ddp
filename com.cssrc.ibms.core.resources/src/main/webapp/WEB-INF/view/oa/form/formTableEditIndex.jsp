...
<script type="text/javascript">
	function editIndex(tableId, tableName, indexName) {
		var url = __ctx + "/oa/form/formTable/indexDialog.do?isAdd=0&" + "tableId=" + tableId + "&tableName=" + encodeURIComponent(tableName) + "&indexName=" + encodeURIComponent(indexName);
		url = url.getNewUrl();
	...
	function addIndex() {
		...
		var url = __ctx + "/oa/form/formTable/indexDialog.do?isAdd=1&" + "tableId=" + tableId + "&tableName=" + encodeURIComponent(tableName);
		url = url.getNewUrl();
	...
	<div class="panel">
		...
		<div class="panel-data">
			<form id="frmIndexes">
				...
				<display:table name="tableIndexes" id="index" requestURI="editIndex.do" sort="external" cellpadding="1" cellspacing="1" export="false" class="table-grid">
					...
					<display:column title="管理" media="html" style="text-align:left;">
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<a href="delIndex.do?tableName=${table.tableName}&indexName=${index.indexName}" class="link del">删除</a>
							</c:otherwise>
						</c:choose>
					</display:column>
				</display:table>
