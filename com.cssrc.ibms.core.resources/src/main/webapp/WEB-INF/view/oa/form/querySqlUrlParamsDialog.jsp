...
<script type="text/javascript">
	...
	$(function() {
		...
		_SysQuerySqlEdit_.initUrlParamsData(conf);
	});
	function save() {
...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/sysQuerysqlEdit.js"></script>
</head>
<body>
	<div class="panel">
		<div class="panel-top">
						...
						<div class="toolBar" style="margin: 0;">
							<div class="group">
								<a class="link add" id="btnSearch"
									onclick="_SysQuerySqlEdit_.addUrlParams()">添加</a>
							</div>
							
							<div class="group">
								<a class="link del " id="btnSearch"
									onclick="_SysQuerySqlEdit_.delUrlParams();">删除</a>
							</div>
						</div>
					</div>
	...
	<div id="urlParamsTemplate" style="display: none;">
		<table cellpadding="1" cellspacing="1" class="table-detail">
			<tr var="urlParamsTr">
				...
				<td var=""><input type="checkbox" checked="checked" var="isCustomParam" onclick="_SysQuerySqlEdit_.changeTd(this);">
				</td>
				<td var=""><input type="text" var="key" value=""></td>
				<td var="valueTd"><input type="text" var="value" value="">
				</td>
				<td><a class="link del" href="####"
					onclick="_SysQuerySqlEdit_.delTr(this)"></a></td>
			</tr>
		</table>
	</div>
	<!-- 字段选择模板  -->
