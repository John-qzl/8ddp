...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/form/SubRightsTree.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("a.save").click(function() {
			...
			var url=__ctx+ "/oa/flow/subtableRights/save.do";
		...
		$("a.del").click(function() {
			if($('#rightid').val()!=0){
				...
				var tableid = $('#tableid').val();
				 ...
				 var url=__ctx+ "/oa/flow/subtableRights/del.do";
...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/form/SubRights.js"></script>
...
<body >
	...
	<div id="layout" class="panel-body">
		...
		<div position="center" title="子表授权设置" style="overflow: auto;">
			...
			<form id="subAuthorityForm" method="post" action="${ctx}/oa/flow/subtableRights/save.do" >
