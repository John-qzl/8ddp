...
<!-- ueditor -->
<script type="text/javascript" charset="utf-8" src="${ctx}/jslib/ueditor2/design-setting/editor_config.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/jslib/ueditor2/editor_api.js"></script>
<script type="text/javascript">
	var editor,
		tabTitle="${formDefHi.tabTitle}",
		formContainer,
		tabControl,
		locale='zh_cn';;
	$(function(){		
		...
		<form id="formDefForm" method="post" name="formDefForm">
			...
			<table cellpadding="0" cellspacing="0" border="0" style=" margin-bottom:4px;"  class="table-detail">
				<tr style="height:25px;">
					<th>表单标题:</th>
					<td>&nbsp;<input id="subject" type="text" readonly="readonly" name="subject" value="${formDefHi.subject}" validate="{required:true}" class="inputText" style="width:80%" /></td>
					<th>表单描述:</th>
					<td>&nbsp;<input id="formDesc" type="text" readonly="readonly" name="formDesc"	value="${formDefHi.formDesc}" class="inputText" style="width:80%" /></td>
				</tr>
				<tr>
					<th width="10%">表单headHtml:</th>
					<td colspan="3"><textarea id="headHtml" name="headHtml" style="width:80%;height:70px" >${fn:escapeXml(formDefHi.headHtml)}</textarea></td>
				</tr>
			</table>
		
			<div title="表单设计">
				<div id="editor" position="center"  style="overflow:hidden;height:100%;">
					<textarea id="txtHtml" name="html">${fn:escapeXml(formDefHi.html) }</textarea>
