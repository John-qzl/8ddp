...
<script type="text/javascript" src="${ctx}/jslib/tree/jquery.ztree.core.min.js"></script>
...
<head>
	...
	function preview(){
		...
		var url = "";
		if(designType==1){
			url = __ctx+"/oa/form/formDef/preview.do";
		}else{
			url = __ctx+"/oa/form/formHandler/edit.do";
		}
		frm.creatForm("bpmPreview",url);
		frm.addFormEl("name",$("#subject").val());
		frm.addFormEl("title",objForm.title);
		frm.addFormEl("headHtml",$("#headHtml").text());
...
<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link preview" href="####" onclick="javascript:preview();">预览</a></div>
					<div class="group"><a class="link back" href="${returnUrl}" onclick="javascript:stopPropagetion();">返回</a></div>
				</div>
			</div>
			</c:if>
		</div>
		<div class="panel-body">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<th width="20%">表单headHtml:</th>
					<td colspan="3" id="headHtml">${fn:escapeXml(bpmFormDef.headHtml)}</td>
				</tr>
