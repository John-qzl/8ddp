...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#dataFormSave").click(function() {
			...
			var url = __ctx + "/oa/form/formTable/saveIndex.do?isAdd=" + isAdd;
			$.post(url, $('#frmIndex').serialize(), function(data) {
				var obj = new com.ibms.form.ResultMessage(data);
				if (obj.isSuccess()) {
					$.ligerDialog.success(obj.getMessage(),'提示信息',function(item, Dialog, index){
						dialog.get("sucCall")();
						dialog.close();		
					});					
				} else {
...
<body>
	<div class="panel-top">
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group">
					<a class="link save" id="dataFormSave" >添加</a>
				</div>
				
				<div class="group">
					<a class="link del" href="javascript:;" onclick="dialog.get('sucCall')();dialog.close();">关闭</a>
				</div>
			</div>
