...
<script type="text/javascript">
	...
	$(function(){
		...
		if(tableId>0){
			...
			$.get("getByTableId.do",{tableId:tableId},function(data){
				table=data.table;
			...
			$.get("getTableModel.do",{dataSource:dataSource,tableName:tableName},function(data){
				bindExtTable(data);
				table=data.table;
			});
		}
	...
	function handSave(){
		$("#dataFormSave").click(function(){
			...
			$.post("saveExtTable.do",{table:tableJson,fields:fieldJson},showResponse);
		});
	}
...
<body>
	<div class="panel">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group">
					    <!--  
						<c:if test="${tableId!=0 }">
							<div class="group"><a id="syncToExtTable" class="link reload">同步外部表</a></div>
		...
		<div class="panel-body">
			<form id="bpmTableForm" method="post" action="add2.do">
