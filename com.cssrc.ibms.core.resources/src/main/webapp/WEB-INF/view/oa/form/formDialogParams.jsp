		...
		<div class="panel-body">
				...
				<span id="callCode" style="display:none;">
					...
					<tr>
						...
						&lt;script type="text/javascript" src="\${ctx}/jslib/ibms/oa/form/CommonDialog.js"&gt;&lt;/script&gt;；</td>
					</tr>
					<tr>
					...
					<tr>
						...
						&lt;script type="text/javascript" src="\${ctx}/jslib/ibms/oa/form/CommonDialog.js"&gt;&lt;/script&gt;<br>
