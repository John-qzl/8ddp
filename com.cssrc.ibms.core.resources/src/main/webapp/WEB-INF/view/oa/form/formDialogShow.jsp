...
<script type="text/javascript" src="${ctx}/jslib/util/ObjectUtil.js"></script>
<script type="text/javascript">
	...
	//获取子页面中的table菜单栏
	function getToolsTr(toolsTr){
		thead = toolsTr.html();
	}
	function onChecked(obj,tr,textarea) {
		textareaArrys.push(textarea);
		...
		if (existsIndex == -1 && (checked == true || checked == 'checked')) {
			...
			$(copyTr.find('td')[0]).html('<a class="link del" onclick="deleteTr(this)" href="####" title="删除"></a>');
...
<body style="margin: 0;">
	<iframe src="showFrame.do?<%=request.getQueryString()%>"
		id="dialogFrame" name="dialogFrame" width="100%" height="100%"
		frameborder="0"
		onload="this.height=document.body.scrollHeight-7"></iframe>
	<div class="panel hidden">
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link back" id="btnBack" onclick="back()">返回</a></div>
				</div>
			</div>
		</div>
