...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/expressionMakerDialog.js"></script>
...
<script type="text/javascript">
	...
	//获取脚本数据
	function getScript() {
		var url = __ctx + "/oa/system/sysScript/getScripts.do";
	...
	//获取流程变量，构建变量树
	function getVar() {
		var url = __ctx + "/oa/flow/defVar/getVars.do";
		$.post(url, {
			defId : "1343718637626"
		}, function(result) {
			var setting = {
	...
	function valiExpression() {
		...
		var url = __ctx + "/oa/console/getValidateResult.do";
		$.post(url, {
			script : script
		}, function(obj) {
...
<!-- 				</div> -->
		...
		<div class="bottom_div">
			<div class="l-tab-links title-div" style="display:inline;margin-left:10px">规则表达式
