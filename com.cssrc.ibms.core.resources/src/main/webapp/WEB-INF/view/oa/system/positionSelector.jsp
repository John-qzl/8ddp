...
<body>
	<div class="panel">
		<div class="panel-search">
				<form id="searchForm" action="selector.do" method="POST" target="posFrame">
					<div class="row">
						<input type="hidden" name="isSingle" value="${isSingle }">
						<span class="label">岗位名称:</span> 
						<input type="hidden" name="pid" id="pid" /> 
						<input type="text" id="posName" name="Q_posName_SL" class="inputText" size="20" value="${param['Q_posName_SL']}"/> &nbsp; 
		...
		<div class="panel-body">
			<div class="panel-data">
				...
				<c:set var="checkAll">
				 ...
				 <display:table name="positionList" id="positionItem" requestURI="selector.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
					...
					<c:choose>
						...
						<c:otherwise>
						<input type="radio" class="pk" name="posId" onclick="singleCheck()" value="${positionItem.posId}#${positionItem.posName}">
						</c:otherwise>
					</c:choose>
				...
				<ibms:paging tableId="positionItem" showExplain="true"/>
			</div>
 		</div>
