...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/ConditionExpression.js"></script>
...
<script type="text/javascript">
	...
	function preview() {
		...
		var url = __ctx + '/oa/system/sysUserParam/getByParamKey.do';
		url=url.getNewUrl();
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a onclick="addDiv(3)" class="link add">添加</a></div>
