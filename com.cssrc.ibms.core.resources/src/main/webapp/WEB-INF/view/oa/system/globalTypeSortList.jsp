	...
	$(function(){
		...
		$("a.save").click(function() {
			...
			if(typeIds.length>1){
				...
				var url="${ctx}/oa/system/globalType/sort.do";
...
<div class="panel-top">
				...
				<div class="panel-toolbar">
					<div class="toolBar">
						...
						<div class="group"><a class="link close"  href="javascript:;" onclick="dialog.get('sucCall')();dialog.close();">关闭</a></div>
					</div>
				</div>
		</div>
			...
			<table class="table-detail"  border="0" cellspacing="0" cellpadding="0" >
				...
				<tr>
					<td class="form_title" align="center" >
						<select id="typeIds" name="typeIds" size="19" style="width:100%;height:auto;" multiple="multiple">
