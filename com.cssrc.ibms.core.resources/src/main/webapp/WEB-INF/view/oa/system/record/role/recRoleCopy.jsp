		...
		<form id="frmCopy" name="frmCopy">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td><input type="text" id="roleName" name="roleName" class="inputText" disabled="disabled" value="${recRole.roleName }"/></td>
					<th width="15%">新角色名称: </th>
					<td><input type="text" id="newRoleName" name="newRoleName"class="inputText"/></td>
				</tr>
				<tr>
					<th width="15%">原别名: </th>
					<td><input type="text" id="alias" name="alias" class="inputText" disabled="disabled" value="${recRole.alias }"/></td>
					<th width="15%">新别名: </th>
