...
<title>条件脚本编辑</title>
<f:link href="from-jsp.css"></f:link><script type="text/javascript" src="${ctx}/jslib/util/easyTemplate.js" ></script>
<script type="text/javascript" src="${ctx}/servlet/ValidJs?form=conditionScript"></script>
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/ScriptEdit.js"></script>
<script type="text/javascript">
	...
	function classNameChange(){
		...
		var url = __ctx + '/oa/system/conditionScript/getMethodsByName.do?name='+className;
		getMethods(url);
	};
</script>
</head>
	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group">
						<a class="link save" onclick="save('conditionScriptEdit')">保存</a>
					</div>
		...
		<form id="conditionScriptEdit" method="post" action="save.do">
