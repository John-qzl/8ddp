...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#viewFrame").height($('#tableView').height()-$('.l-layout-header').height())
		height = $('#layout').height();
		loadTree("");
		$("#treeReFresh").click(function() {
			loadTree("");
			$("#viewFrame").attr("src","${ctx}/oa/system/sysCodegen/detail.do");
		});
	...
	function loadTree(subject) {
		...
		$.post(
			"${ctx}/oa/system/sysCodegen/getTableData.do?subject="+subject,
			function(result) {
	...
	function zTreeOnCheck(event, treeId, treeNode){
		...
		var url="${ctx}/oa/system/sysCodegen/detail.do?flowName="+encodeURIComponent(flowName)
...
<body>
	<div id="layout" style="bottom: 1; top: 1">
		...
		<div position="center" id="tableView" style="height: 100%;">
			...
			<iframe id="viewFrame" src="${ctx}/oa/system/sysCodegen/detail.do" frameborder="0" width="100%"></iframe>
		</div>
	</div>
</body>
</html>