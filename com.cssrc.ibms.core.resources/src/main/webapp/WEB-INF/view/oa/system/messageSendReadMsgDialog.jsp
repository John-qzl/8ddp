...
<head>
	...
	// 查看下一条信息
	function nextMsg(){
		var url=__ctx + "/oa/system/messageSend/readMsgDialog.do";
			...
			<div class="panel-detail">
				<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<th width="20%">回复内容:</th>
						<td colspan="3">
							<form id="messageReplyForm" name="messageReplyForm" action="${ctx}/oa/system/messageReply/reply.do" method="post">
