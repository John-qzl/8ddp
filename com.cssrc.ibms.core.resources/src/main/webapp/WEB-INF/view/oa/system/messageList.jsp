			...
			<div class="hide-panel">
				...
				<div class="panel-body">
					...
					<div class="panel-data">
					    ...
					    <display:table name="messageList" id="messageItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:180px;text-align:center">
								<a href="del.do?messageId=${messageItem.messageId}" class="link del">删除</a>
								<a href="edit.do?messageId=${messageItem.messageId}" class="link edit">编辑<</a>
								<a href="get.do?messageId=${messageItem.messageId}" class="link detail">明细</a>
							</display:column>
						</display:table>
						<ibms:paging tableId="messageItem"/>
					</div>
