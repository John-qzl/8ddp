...
<script type="text/javascript">
	var win;
	function test(setId){
		var url=__ctx+'/oa/system/sysWs/test.do?setId='+setId;
...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a onclick="developHelp()" class="link copyTo">开发帮助</a></div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="bpmCommonWsSetList" id="bpmCommonWsSetItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="del.do?id=${bpmCommonWsSetItem.id}" class="link del">删除</a>
					<a href="edit.do?id=${bpmCommonWsSetItem.id}" class="link edit">编辑</a>
					<a href="####" onclick="test(${bpmCommonWsSetItem.id})" class="link detail">测试</a>
				</display:column>
			</display:table>
			<ibms:paging tableId="bpmCommonWsSetItem"/>
