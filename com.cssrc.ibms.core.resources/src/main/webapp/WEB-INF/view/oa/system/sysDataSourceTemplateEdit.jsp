...
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/sysDataSourceTemplate/EditController.js"></script>
...
<div class="panel">
	<div class="panel-top">
		<div class="tbar-title">
		    <c:choose>
			    <c:when test="${sysDataSourceTemplate.id !=null}">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" ng-click="save(prop)">保存</a></div>
	...
	<div class="panel-body">
		<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
			<tr>
				<th width="20%">名称: </th>
				<td><input type="text" ng-model="prop.name" validate="{required:true,maxlength:64}"  class="inputText" onblur="getKeyName(this)"/></td>
			</tr>
			<tr>
				<th width="20%">别名: </th>
				<td><input id="alias" type="text" ng-model="prop.alias" validate="{required:true,maxlength:64}" class="inputText"/></td>
			</tr>			
			<tr>
			...
			<tr>
				...
				<td>
					<select ng-model="prop.isSystem" ng-options="m.value as m.key for m in CommonList.yesOrNoList2">
					</select>
				</td>
			</tr>
			<tr>
