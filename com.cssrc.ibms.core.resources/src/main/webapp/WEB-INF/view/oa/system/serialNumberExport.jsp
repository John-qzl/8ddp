...
<body>
	...
	<div class="panel-body">
		<form id="exportForm" name="exportForm" method="post" target="download" action="exportXml.do">
			<div class="row">
			 <input type="hidden" name="tableIds" value="${tableIds}" >
			 <table id="tableid" class="table-detail" cellpadding="0" cellspacing="0" border="0">
			 	<tr>
			 		<th width="30%">流水号：</th>
			 		<td width="70%"><input type="checkbox"  name="serialNumber" checked="checked" disabled="disabled"></td>	
			 	</tr>
