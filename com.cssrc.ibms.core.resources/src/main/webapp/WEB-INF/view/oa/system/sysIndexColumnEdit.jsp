...
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/BpmQueryDialog.js"></script>
	<script type="text/javascript">
		...
		function setParam(){
			DialogUtil.open({
				...
				width: 660,
				title : '参数设置',
				url: __ctx+"/oa/system/sysIndexColumn/setParam.do", 
				isResize: true,
				//自定义参数
...
<body>
<form id="frmSubmit" method="post" action="save.do">
<div class="panel">
	<div class="panel-top">
