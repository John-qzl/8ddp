...
<%@ taglib prefix="do" tagdir="/WEB-INF/tags/wf"%>
<html>
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/sysObjRights/SysObjRightsService.js"></script>
	<script type="text/javascript" src="${ctx}/jslib/ibms/oa/system/sysObjRights/EditController.js"></script>
...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" ng-click="save()">保存</a></div>
				<div class="group"><a class="link back" href="javaScript:frameElement.dialog.close();">关闭</a></div>
			</div>
		</div>
	</div>
