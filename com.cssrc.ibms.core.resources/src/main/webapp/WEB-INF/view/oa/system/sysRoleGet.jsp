...
<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link back" href="../sysRole/list.do">返回</a></div>
				</div>
			</div>
			</c:if>
		</div>
		<div class="panel-body">
			<div class="panel-detail">
				<form id="sysRoleForm" method="post" action="add2.do">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td>
							<c:choose>
							<c:when test="${sysRole.status eq 1}">启用</c:when>
							<c:when test="${sysRole.status eq 0}">禁用</c:when>
							<c:otherwise>未设定</c:otherwise>
							</c:choose>
							</td>
						</tr>
