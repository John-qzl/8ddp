			...
			var setting = {
					...
					callback:{
						onClick: function(event, treeId, treeNode){
							...
							var p="?isSingle=${isSingle}&searchBy="+"${SEARCH_BY_ORG}"+"&orgId="+treeNode.orgId+"&includSub="+includSub+"&path="+treeNode.path;
...
<body>
	<div id="defLayout" style="height:100%;">
		...
		<div position="center">
			...
			src="${ctx}/oa/system/sysUser/selector.do?isSingle=${isSingle}&searchBy="+"${SEARCH_BY_ORG}"+"&orgId=${mainOrgId}&includSub=1"></iframe>
		</div>
		<c:if test="${isSingle==false}">
			<div position="right" style="overflow:auto;height:95%;width:170px;"  title="<span><a onclick='javascript:dellAll();' class='link del'>清空 </a><input type='text' class='quick-find' placeholder='查找'/></span>">
