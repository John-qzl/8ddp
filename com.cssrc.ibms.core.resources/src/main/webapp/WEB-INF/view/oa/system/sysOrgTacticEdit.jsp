	...
	<script type="text/javascript">
		$(function() {
			$("a.save").click(function() {
				$("#sysOrgTacticForm").attr("action","save.do");
				submitForm();
			});
			...
			$("#orgTactic").click(function() {
				$("#sysOrgTacticForm").attr("action","${ctx}/oa/system/sysOrg/updCompany.do");
				submitForm();
			});
		});
		//提交表单
	...
	<div class="panel-top">
		<div class="tbar-title">
		    <c:choose>
			    <c:when test="${sysOrgTactic.id !=null}">
			        <span class="tbar-label">编辑组织策略</span>
			    </c:when>
			    <c:otherwise>
			        <span class="tbar-label">添加组织策略</span>
			    </c:otherwise>			   
		    </c:choose>
		</div>
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a class="link run" id="orgTactic" href="javascript:void(0)">生成分公司</a></div>
			</div>
		</div>
	</div>
	<div class="panel-body">
		<form id="sysOrgTacticForm" method="post" action="save.do">
