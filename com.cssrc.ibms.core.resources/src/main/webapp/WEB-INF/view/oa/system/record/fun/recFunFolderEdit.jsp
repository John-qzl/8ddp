...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link add" id="dataFormSave" href="javascript:;">创建</a></div>
				
				<div class="group"><a class="link back" href="icons.do">返回</a></div>
			</div>
		</div>
	</div>
	<div class="panel-body" id="folderEdit">
		<form id="folderForm" action="createFolder.do" method="post" >
