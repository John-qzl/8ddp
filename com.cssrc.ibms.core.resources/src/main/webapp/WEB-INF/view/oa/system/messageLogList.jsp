...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="messageLogList" id="messageLogItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
				...
				<display:column title="管理" media="html" style="width:180px;text-align:center">
					<a href="del.do?id=${messageLogItem.id}" class="link del">删除</a>
					<!--
					<a href="edit.do?id=${messageLogItem.id}" class="link edit">编辑</a>
					-->
					<a href="get.do?id=${messageLogItem.id}" class="link detail">明细</a>
				</display:column>
			</display:table>
			<ibms:paging tableId="messageLogItem"/>
