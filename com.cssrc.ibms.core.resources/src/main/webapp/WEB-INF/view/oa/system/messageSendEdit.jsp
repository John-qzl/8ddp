...
<script type="text/javascript"
	src="${ctx }/jslib/ibms/oa/system/MsgDialog.js"></script>
<script type="text/javascript"
...
<script type="text/javascript" charset="utf-8" 
	src="${ctx}/jslib/ueditor2/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" charset="utf-8" 
	src="${ctx}/jslib/ueditor2/themes/default/css/ueditor.css"></script>
<script type="text/javascript" charset="utf-8" 
	src="${ctx}/jslib/ueditor2/form-setting/editor_config.js"></script>
<script type="text/javascript" charset="utf-8" 
	src="${ctx}/jslib/ueditor2/editor_api.js"></script>
<script type="text/javascript">
	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group">
						<a class="link sendMessage" id="dataFormSave" href="javascript:;">发送</a>
					</div>
					
					<div class="group">
						<a class="link back" href="list.do?userId=${userId}">返回</a>
					</div>
				</div>
			</div>
		</div>
		<div class="panel-body">
			<form id="messageSendForm" method="post" action="save.do">
