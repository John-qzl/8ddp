...
function classNameChange(){
	...
	var url = __ctx + '/oa/system/personScript/getMethodsByName.do?name='+className;
	getMethods(url);
};
</script>
</head>
	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group">
						<a class="link save" onclick="save('personScriptEdit')">保存</a>
					</div>
		...
		<form id="personScriptEdit" method="post" action="save.do">
