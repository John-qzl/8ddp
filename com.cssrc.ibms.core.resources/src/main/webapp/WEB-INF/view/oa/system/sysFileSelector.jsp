...
<title>文件选择</title>
<f:link href="from-jsp.css"></f:link><f:link href="jquery.qtip.css" ></f:link>
...
<body >
	<div class="panel">
		...
		<div class="panel-search" >
			<form action="selector.do?isSingle=${param.isSingle }" id="searchForm" method="POST">
				<input type="hidden" name="typeId" id="typeId" /> 
				<span class="label">文件名:</span> 
				<input type="text" id="filename" name="Q_filename_S" style="width:80px;" maxlength="128" class="inputText" value="${param['Q_filename_S']}"/> 
				<span class="label">扩展名:</span> 
				<input type="text" id="ext" name="Q_ext_S" style="width:80px;" maxlength="128" class="inputText" value="${param['Q_ext_S']}"/>
			</form>
		</div>
		<div class="panel-body">
			...
			<display:table name="sysFileList" id="sysFileItem" requestURI="selector.do" sort="external" cellpadding="1"
