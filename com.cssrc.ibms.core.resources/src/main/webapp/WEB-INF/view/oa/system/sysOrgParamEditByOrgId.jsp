...
<f:link href="from-jsp.css"></f:link><script type="text/javascript">
	...
	//返回
	function returnBack(){
	    window.location.href="${ctx}/oa/system/userPosition/userList.do?orgId=${orgId}";
	}
	...
	<div class="panel">
		...
		<div class="panel-body">
			<form id="sysOrgParamForm" method="post"
				action="${ctx }/oa/system/sysOrgParam/saveByOrgId.do">
