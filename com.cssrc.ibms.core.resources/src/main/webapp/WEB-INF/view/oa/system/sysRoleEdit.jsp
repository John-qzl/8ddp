...
<div class="panel">
		...
		<div class="panel-body">
				...
				<form id="sysRoleForm" method="post" action="save.do">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<th width="20%">备注: </th>
							<td>
								<textarea rows="3" cols="50" id="roleDesc" name="roleDesc">${sysRole.roleDesc}</textarea>
						</tr>
						<tr>
							<th width="20%">允许删除: </th>
							<td>
						...
						<tr>
							<th width="20%">是否启用: </th>
							<td>
							    <input type="radio" id="status" name="status" value="1" checked="checked" <c:if test="${sysRole.status==1}"> checked="checked" </c:if> />启用
								<input type="radio" id="status" name="status" value="0"  <c:if test="${sysRole.status==0}"> checked="checked" </c:if> >禁用
							</td>
						</tr>
					</table>
