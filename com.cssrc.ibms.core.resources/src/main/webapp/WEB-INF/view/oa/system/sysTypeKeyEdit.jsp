...
<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">
					<c:choose>
						<c:when test="${sysTypeKey.typeKeyId==0}">
							添加系统分类键定义
						</c:when>
						<c:otherwise>
							编辑系统分类键定义   
		...
		<div class="panel-body">
			<div class="panel-detail">
				<form id="sysTypeKeyForm" method="post" action="save.do">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td>
							<c:choose>
								<c:when test='${sysTypeKey.typeKeyId == null||sysTypeKey.typeKeyId ==0}'>
					...
					<input type="hidden" name="typeKeyId" value="${sysTypeKey.typeKeyId}" />
				</form>
			</div>
		</div>
</div>
