...
<script type="text/javascript" src="${ctx}/jslib/ibms/oa/bpm/RuleDialog.js" ></script>
<script type="text/javascript" src="${ctx}/jslib/javacode/codemirror.js"></script>
<script type="text/javascript"src="${ctx}/jslib/ibms/oa/system/ConditionScriptAddDialog.js"></script>
<script type="text/javascript"src="${ctx}/jslib/ibms/oa/system/ConditionScriptDialog.js"></script>
