...
<script type="text/javascript">
	function design(id){
		var url = __ctx+"/oa/system/sysIndexLayoutManage/design.do";
		if(id)
			url = __ctx+"/oa/system/sysIndexLayoutManage/design.do?id="+id;
		$.openFullWindow(url);
	}
...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysIndexLayoutManageList" id="sysIndexLayoutManageItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:50px;text-align:center" class="rowOps">
					<a href="del.do?id=${sysIndexLayoutManageItem.id}" class="link del">删除</a>
			...
			<ibms:paging tableId="sysIndexLayoutManageItem"/>
