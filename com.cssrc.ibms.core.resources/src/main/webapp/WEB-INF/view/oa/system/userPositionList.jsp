...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="userPositionList" id="userPositionItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:220px">
					<a href="del.do?userPosId=${userPositionItem.userPosId}" class="link del">删除</a>
					<a href="edit.do?userPosId=${userPositionItem.userPosId}" class="link edit">编辑</a>
					<a href="get.do?userPosId=${userPositionItem.userPosId}" class="link detail">明细</a>
				</display:column>
			</display:table>
