...
<body>
	<div class="panel">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.do">
					<ul class="row plat-row">
						...
						<li><span class="label" title="印章持有者姓名:">印章持有者姓名:</span><input type="text" name="Q_belongName_SL"  class="inputText" value="${param['Q_belongName_SL']}"/></li>
					</ul>
				</form>
			</div>
		</div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sealList" id="sealItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
				...
				<display:column title="管理" media="html" style="width:180px;text-align:center" >
					<a href="del.do?sealId=${sealItem.sealId}" class="link del">删除</a>
					<a href="edit.do?sealId=${sealItem.sealId}" class="link edit">编辑</a>
					<a href="get.do?sealId=${sealItem.sealId}" class="link detail">明细</a>
				</display:column>
			</display:table>
			<ibms:paging tableId="sealItem"/>
		</div>	
