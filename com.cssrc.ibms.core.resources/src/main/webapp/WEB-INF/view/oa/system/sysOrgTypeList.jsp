...
<%@include file="/commons/include/get.jsp" %>
	<script type="text/javascript">
		...
		function save(){
			...
			$.post('${ctx }/oa/system/sysOrgType/multSave.do',{'ids':ids},function(responseText){
							...
							if (obj.isSuccess()) {
								$.ligerDialog.confirm( obj.getMessage()+",是否继续操作","提示信息", function(rtn) {
									if(rtn){
										...
										window.location.href = "${ctx}/oa/system/demension/list.do";
									}
								});
							} else {
	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link add"  href="edit.do?demId=${demId}">添加</a></div>
								
					<div class="group"><a class="link del"  action="del.do">删除</a></div>
					
					
					<div class="group"><a class="link save"  action="del.do" href="javascript:;">保存排序</a></div>
					
					<div class="group"><a class="link back" href=" ${ctx}/oa/system/demension/list.do">返回</a></div>
				</div>	
			</div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysOrgTypeList" id="sysOrgTypeItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
				...
				<display:column title="管理" media="html" style="width:180px">
					...
					<a href="del.do?id=${sysOrgTypeItem.id}" class="link del">删除</a>
					<a href="edit.do?id=${sysOrgTypeItem.id}" class="link edit">编辑</a>
				</display:column>
			</display:table>
