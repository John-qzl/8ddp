...
<%@page import="com.cssrc.ibms.system.model.SysBaseParam,
		com.cssrc.ibms.core.util.string.StringUtil,
		java.util.*,
...
%>
	<input title='paramValue' <%if(param.getDataType().equals("Date")){ %>class="date" <%}else{%>class="inputText "<%}%>type="text" name="<%=paramId%>" value="<%=paramValue%>" style="width:150px !important" class="inputText">
<%
}
