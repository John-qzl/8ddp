...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysIndexLayoutList" id="sysIndexLayoutItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html"  style="width:50px;text-align:center" class="rowOps">
					<a href="del.do?id=${sysIndexLayoutItem.id}" class="link del">删除</a>
					<a href="edit.do?id=${sysIndexLayoutItem.id}" class="link edit">编辑</a>
					<a href="get.do?id=${sysIndexLayoutItem.id}" class="link detail">明细</a>
				</display:column>
			</display:table>
			<ibms:paging tableId="sysIndexLayoutItem"/>
