...
<script type="text/javascript">
	...
	function previewTemplate(id,columnName){
		var url = __ctx+"/oa/system/sysIndexColumn/getTemp.do?id="+id;
		url=url.getNewUrl();
	...
	function setRights(columnId){
		//var url = __ctx+"/oa/system/sysIndexColumnRights/set.do?columnId="+columnId;
		//url=url.getNewUrl();
		var url = __ctx+"/oa/system/sysObjRights/edit.do?objectId="+columnId+"&objType=sic";
		DialogUtil.open({
			height:500,
			width: 600,
			title : "设置授权",
	...
	function saveOrg(id,orgId){
		$.ajax({
			type : "POST",
			url : __ctx+"/oa/system/sysIndexColumn/saveOrg.do",
			data : {
				id:id,
				orgId:orgId
			},
...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a  class="link init" action="init.do">初始化模板</a></div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="sysIndexColumnList" id="sysIndexColumnItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="管理" media="html" style="width:50px;text-align:center" class="rowOps">
					<a href="del.do?id=${sysIndexColumnItem.id}" class="link del">删除</a>
					<a href="edit.do?id=${sysIndexColumnItem.id}" class="link edit">编辑</a>
			...
			<ibms:paging tableId="sysIndexColumnItem"/>
