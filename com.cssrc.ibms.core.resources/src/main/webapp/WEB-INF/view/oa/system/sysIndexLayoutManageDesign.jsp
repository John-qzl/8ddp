...
<%@include file="/commons/include/home.jsp"%>
	<f:link href="ibms/layoutit.css"></f:link>
	<script type="text/javascript" src="${ctx }/jslib/jquery/plugins/jquery-ui.min.js"></script>
	<script type="text/javascript" src="${ctx }/jslib/jquery/plugins/jquery.htmlClean.js"></script>
	<script type="text/javascript" src="${ctx }/jslib/ckeditor/ckeditor.js"></script>
	<script type="text/javascript" src="${ctx }/jslib/ckeditor/ckeditor_indexconfig.js"></script>
	<script type="text/javascript" src="${ctx }/jslib/ibms/index/indexLayout.js"></script>
	<!--[if IE]>
