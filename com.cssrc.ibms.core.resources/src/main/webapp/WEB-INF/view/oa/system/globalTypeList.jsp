...
<head>
	...
	<script type="text/javascript">
		function addNew(parentId,catKey,returnUrl,type)
		{
			...
			{
				location.href="add1.do?parentId="+parentId+"&catKey="+catKey+"&type="+type+"&returnUrl="+returnUrl;
			}
		}
	</script>
</head>
			...
			<div class="hide-panel">
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link add" onclick="addNew('${parentId}','${catKey}','${returnUrl}','${type}')"  href="javascript:;">添加分类</a></div>
				...
				<div class="panel-body">
					...
					<div class="panel-data">
					    ...
					    <display:table name="globalTypeList" id="globalTypeItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:180px;text-align:center">
								<a href="del.do?typeId=${globalTypeItem.typeId}" class="link del">删除</a>
								<a href="upd1.do?typeId=${globalTypeItem.typeId}&returnUrl=${returnUrl}" class="link edit">编辑</a>
								<a href="get.do?typeId=${globalTypeItem.typeId}" class="link detail">明细</a>
							</display:column>
						</display:table>
						<ibms:paging tableId="globalTypeItem"/>
					</div>
