	...
	<script type="text/javascript">
		...
		function reSortListSn(trObj,url){
			...
			if(dicIds.length>1){
				...
				form.creatForm("form", "${ctx}/oa/system/dictionary/sort.do");
		...
		function addNew(parentId,typeId,returnUrl)
		{
			...
			{
				location.href="add1.do?typeId="+typeId+"&returnUrl="+returnUrl;
			}
		}
			...
			<div class="hide-panel">
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link add\" onclick="addNew('${parentId}','${typeId}','${returnUrl}')" href="javascript:;">添加字典</a></div>
				...
				<div class="panel-body">
					...
					<div class="panel-data">
					    ...
					    <display:table name="dictionaryList" id="dictionaryItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:300px;text-align:center">
								<a href="del.do?dicId=${dictionaryItem.dicId}" class="link del">删除</a>
								<a href="upd1.do?dicId=${dictionaryItem.dicId}&returnUrl=${returnUrl}" class="link edit">编辑</a>
								<a href="get.do?dicId=${dictionaryItem.dicId}" class="link detail">明细</a>
