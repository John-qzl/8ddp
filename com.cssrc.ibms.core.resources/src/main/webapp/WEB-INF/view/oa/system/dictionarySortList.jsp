	...
	$(function(){
		...
		$("a.save").click(function() {
			...
			if(dicIds.length>1){
				...
				var url="${ctx}/oa/system/dictionary/sort.do";
...
<div class="panel-top">
				...
				<div class="panel-toolbar">
					<div class="toolBar">
						<div class="group"><a class="link save" id="dataFormSave" onclick="dialog.get('sucCall')();" href="javascript:;">保存</a></div>
			...
			<table class="table-detail"  border="0" cellspacing="0" cellpadding="0" >
				...
				<tr>
					<td class="form_title" align="center" >
						<select id="dicIds" name="dicIds" size="19" style="width:100%;height:auto;" multiple="multiple">
