...
<%@ page language="java" import="com.cssrc.ibms.core.msg.model.MessageSend" %>
<html>
<head>
	<title>发送消息管理</title>
...
<body>
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link  sendMessage" href="edit.do">发送消息</a></div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="messageSendList" id="messageSendItem" requestURI="list.do" 
				...
				<display:column title="管理" media="html" style="width:180px;text-align:center">
					<a href="del.do?id=${messageSendItem.id}" class="link del">删除</a>
					<a href="edit.do?id=${messageSendItem.id}" class="link edit" style='${longTime-messageSendItem.sendTime.time > spanTime ?'display:none':'display:'}'>编辑</a>
					<a href="get.do?id=${messageSendItem.id}" class="link detail">明细</a>
				</display:column>
			</display:table>
			<ibms:paging tableId="messageSendItem"/>
