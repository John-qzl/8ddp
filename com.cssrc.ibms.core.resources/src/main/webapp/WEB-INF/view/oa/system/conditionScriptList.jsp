...
<body>
	<div class="panel">
		...
		<div class="panel-body">
		    ...
		    <display:table name="conditionScriptList" id="conditionScriptItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
				...
				<display:column title="方法名称" sortable="true" sortName="METHOD_NAME">
					<a class="link" href="edit.do?id=${conditionScriptItem.id}" style="color:blue;">${conditionScriptItem.methodName}</a> 
				</display:column>
			...
			<ibms:paging tableId="conditionScriptItem"/>
		</div>
	</div>
</body>
</html>
