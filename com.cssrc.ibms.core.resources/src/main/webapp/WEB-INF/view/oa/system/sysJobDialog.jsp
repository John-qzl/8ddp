...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				initData();
				$("#jobFrame").attr("src","${ctx}/oa/system/job/selector.do?isSingle=${param.isSingle}");
			});
	...
	<body >
		<div id="defLayout" >
				 ...
				 <div position="center">
	          		<iframe id="jobFrame" name="jobFrame" height="100%" width="100%" frameborder="0" src="${ctx}/oa/system/job/selector.do?isSingle=${param.isSingle}"></iframe>
	             </div>
	             
		          <div position="right" title="<span><a onclick='javascript:dellAll();' class='link del'>清空</a><input type='text' class='quick-find' placeholder='查找'/></span>" style="overflow: auto;height:95%;width:170px;">
