	...
	<div class="panel-top">
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a id="btnAddParameter" onclick="addDataParam()" class="link add">添加</a></div>
				<div class="group"><a class="link close" href="javascript:dialog.close();">关闭</a></div>
			</div>
		</div>
	</div>
