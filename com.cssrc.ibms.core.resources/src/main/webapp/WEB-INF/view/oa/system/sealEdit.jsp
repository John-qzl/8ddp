		...
		<div class="panel-top" >
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link download" >导出</a></div>
					<div class="group"><a class="link upload" >导入</a></div>
				</div>
			</div>
		</div>
		<div class="panel-body">
				<form id="sealForm" method="post" action="save.do">
								   ...
								   <table id='rightTable' width='100%'>
								        <tr>
											...
											<td><select id="rightType" name="rightType"
												style="width: 70px;" onchange="changeRight(this)">
