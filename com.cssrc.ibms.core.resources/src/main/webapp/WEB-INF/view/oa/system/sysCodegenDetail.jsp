...
<script type="text/javascript" src="${ctx}/jslib/ibms/absoulteInTop.js" ></script>
	...
	function initTable(){
		...
		try{
			...
			for(var i=0;i<nodes.length;i++){
				...
				$.post("${ctx}/oa/form/formDef/getTableInfo.do?formDefId="+formDefId,function(data){
		...
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link download" href="downLoadZip.do" target="_blank">下载</a></div>
				</div>
			</div>
		</div>
		<div class="panel-body">
		<form method="post" id="codeForm" target="_blank" action="codegenZip.do">
			...
			<div position="top">
				<ul class="row plat-row">
					<li><!-- <span class="label">是否覆盖原有文件:</span><input type="checkbox" name="override" value="1" /> -->
						...
						--%><span class="label">系统名称:</span><input type="text" class="inputText" id="system" name="system" value="${system }" validate="{required:true}" />
					</li>
