	...
	<div id="defLayout">
		<div id="centerLayout" position="center"  style="overflow: auto;">
			<div class="panel-top" usesclflw="true">
	    	 ...
	    	 <display:table name="sysIndexLayoutManageList" id="sysIndexLayoutManageItem" requestURI="dialog.do" sort="external" cellpadding="1" cellspacing="1" class="table-grid">
