...
<script type="text/javascript">
	$(function() {
		...
		$("div.group > a.link.primary").click(function()
			{	
				var conf={};				
				var url=__ctx + "/oa/system/userUnder/myLeaders.do";
				conf.url=url;
				var dialogWidth=550;
	...
	<div class="hide-panel">
		<div class="panel-top">
			...
			<div class="panel-search">
					<form id="searchForm" method="post" action="list.do?userId=${userId}">
		...
		<div class="panel-body">
			    ...
			    <display:table name="userUnderList" id="userUnderItem" requestURI="list.do" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
					...
					<display:column title="管理" media="html" style="width:180px;text-align:center">
						<a href="del.do?id=${userUnderItem.id}" class="link del">删除</a>
						
					</display:column>
				</display:table>
				<ibms:paging tableId="userUnderItem" showExplain="false"/>
