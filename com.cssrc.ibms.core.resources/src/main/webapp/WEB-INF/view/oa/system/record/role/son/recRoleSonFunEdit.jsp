...
<head>
	...
	<script type="text/javascript">
		...
		function loadLeftTree(){
			...
			//一次性加载
			var url="${ctx}/oa/system/recFun/getRecRolSonFunTreeChecked.do?roleSonId=${roleSonId}&typeId=${typeId}";			
		...
		function getRightTreeServer(funId){
			var url="${ctx}/oa/system/recFun/getButtonSonTreeChecked.do?roleSonId=${roleSonId}&funId="+funId;	
			$.post(url,function(result){
				var parentButton = {};
				parentButton.id = 0;
		...
		function save(){
			...
			var url="${ctx}/oa/system/recRoleSonFun/upd.do";
			var data= "roleSonId=${roleSonId}&dataJson="+dataJson;
