...
<script type="text/javascript">
	...
	function getOffice(){
		OfficePlugin.init();
		var path= "${ctx}/oa/system/sysFile/file_${param.fileId}.do";
		try{
		...
		<div class="panel-top">
			<div class="panel-toolbar">
				<div class="toolBar" style="height:30px;">
					<c:if test="${ rights=='w'}">
						<div class="group"><a id="saveOffice" class="link2 save" href="####">保存</a></div>
					
					</c:if>
					
					<div class="group"><a id="downLoad" class="link2" href="${ctx}/oa/system/sysFile/file_${param.fileId}.do">下载</a></div>
				</div>
			</div>
		</div>
