...
<f:js pre="jslib/lang/view/oa/form" ></f:js>
	...
	var isClient = dialog.options.params.isClient;
	$(function(){
		debugger;
		var selector = isClient?"[name=client]":"[name=server]";
		$(selector).show();
		 ;
		//获取选中的发次对应的型号ID
		var xhId = dialog.options.params.xhId;
		$('#xhId').val(xhId);
	...
	function valid(showResponse){
		var method = isClient?"clientImportPackages.do":"serverImportPackages.do";
		var options={success:showResponse,url:__ctx+'/dataPackage/tree/ptree/'+method};
