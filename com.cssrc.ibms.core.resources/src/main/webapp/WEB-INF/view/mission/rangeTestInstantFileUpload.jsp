...
<%--            <div class="group"><a class="link down" href="${ctx}/temp/FlashInstall.exe">Flsh插件</a></div>
    ...
    <div class="panel-body">
        ...
        <p><a href="/dp/temp/靶场试验问题表模板.xls" style="font-size:18px;" onclick="AttachMent.handleClickItem(this)">1.靶场试验问题表模板</a><a href="javascript:;" title="下载" class="link download"></a></p>
        <%--
...
<script type="text/javascript">
    ...
    actionUrl = '${ctx}/model/instance/rangeTestinstantfileUpload.do?missionId=' + missionId ;
