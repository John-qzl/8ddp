...
<body>
                ...
                <table class="layui-table">
                  <tbody>
                   ...
                   <tr>
                      ...
                      <td><input id="Type"  name="Type" type="text" value="${tabletemp.F_ZL}"/><span id="typeMsg" /></td>
                    </tr>
                     <tr>
                      <td><span>签署：</span></td>
                      <td id="3">
   ...
   <div class="panel-toolbar" style="background:none;">
	...
	<input type="hidden" id="moduleId" name="moduleId" value="${id}"/>
	</form>
</body>
</html>
