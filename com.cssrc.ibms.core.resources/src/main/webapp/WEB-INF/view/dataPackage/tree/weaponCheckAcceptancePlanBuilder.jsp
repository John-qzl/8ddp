...
<head>
    ...
    <script type="text/javascript">
        ...
        function openDefaultFrame() {
            // 武器所检-表单下发 节点
            debugger;
            var formAssignUrl = "${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000031900644"
                //	  				+ "&batchName=" + batchKey
        ...
        $(function () {
            ...
            $('.layui-tab-title').on('click', 'li', function () {
                switch ($(this).attr("tabid")) {
                    ...
                    case "dataReturnView":
                        // 数据回传查看
                        var dataReturnViewUrl = "${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000031940042"
                            + "&missionId=" + acceptancePlanId;
                        $("#dataReturnView").attr("src", encodeURI(encodeURI(dataReturnViewUrl)));
                        break;
                    case "acceptanceSummary":
                        // 数据确认
                        var acceptanceSummaryUrl = "${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000031940111"
                            + "&acceptancePlanId=" + acceptancePlanId
                    ...
                    case "file":
                        // 归档
                        fileurl = "${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000031940152"
                            + "&xhId=" + xhId
