...
<head>
    ...
    <script type="text/javascript">
        ...
        function openDefaultFrame() {
            // 顶层文件夹节点
            var acceptancePlanUrl = "${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000031900580&missionId=" + missionId + "&moduleId="+ moduleId+"&moduleCode="+moduleCode+ "&__dbomSql__=F_XHID="+moduleId;
        ...
        $(function (){
            ...
            $('.layui-tab-title').on('click','li',function(){
				 ...
				 */
                    case "acceptancePlan":
                        // 验收策划
                        var acceptancePlanUrl = "${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000031900580&batchId=" + batchId + "&batchName=" + batchKey+"&__dbomSql__=F_SSCPPC="+batchId;
                        $("#acceptancePlan").attr("src", encodeURI(encodeURI(acceptancePlanUrl)));
                        break;
                    /* 表单下发 + 数据回传查看*/
                    case "formAssign":
                    ...
                    case "productTemplate":
                        ...
                        var productTemplateUrl = "${ctx}/dp/missionFormManage.do?fcId=" + moduleId + "&fcName=全部任务&type=WQSJ";
                        debugger;
                        $("#productTemplate").attr("src", encodeURI(encodeURI(productTemplateUrl)));
                        break;
                    case "importDataHistory":
                        //数据导出
                        fileurl="${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000033320236&__dbomSql__=F_ssxhhpc="+ moduleId;
                        $("#importDataHistory").attr("src", encodeURI(encodeURI(fileurl)));
                        break;

                    case "exportdata":
                        //数据导出
                        fileurl="${ctx}/oa/form/dataTemplate/preview.do?__displayId__=10000031940172&xhId="+ moduleId;
