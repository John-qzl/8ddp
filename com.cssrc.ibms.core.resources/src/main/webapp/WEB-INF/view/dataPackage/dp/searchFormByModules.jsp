...
<script>
    ...
    function draw() {
        ...
        switch (drawCondition) {
            ...
            case "numberOfProduct":drawByNumberOfProduct();break;
...
<div style="height:240px;padding-left: 10px" >
    <div style="padding-bottom: 5px">
        ...
        <select id="drawConditionSelecter" onchange="draw()">
            <option value="numberOfPlan" selected>验收次数</option>
            <option value="numberOfTeamMember">验收人数</option>
            <option value="numberOfProduct">产品数量</option>
       ...
       <table class="table-grid table-list">
           ...
           <tr>
               <th style="width:100px">验收次数</th>
                <c:forEach items="${modelMapList}" var="modelMap">
                    <td >${modelMap.countNumberOfPlan}</td>
                </c:forEach>
           </tr>
           <tr>
               <th style="width:100px">验收人数</th>
                <c:forEach items="${modelMapList}" var="modelMap">
           ...
           <tr>
               <th style="width:100px">产品数量</th>
                <c:forEach items="${modelMapList}" var="modelMap">
                    <td >${modelMap.countNumberOfProduct}</td>
                </c:forEach>
           </tr>
           <tr>
