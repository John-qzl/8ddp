      ...
      , i = {
        ...
        appendNodes: function(b, a, c, d, f, g) {
            ...
            for (var e = [], j = b.data.key.children, k = 0, m = c.length; k < m; k++) {
                ...
                o[j] && o[j].length > 0 && (t = i.appendNodes(b, a + 1, o[j], o, f, g));
                ...
                o.isParent && i.makeUlHtml(b, o, e, t.join("")),
        ...
        makeDOMNodeIcon: function(b, a, c) {
            ...
            var d = h.getNodeName(a, c)
              ...
              //只为顶层添加图标和箭头
              if(c.level == 0) {
				b.push("<span id='viewFramework-sidebar-iconResId-", c.resId, "' title='", d, "' treeNode", e.id.ICON, " class='viewFramework-sidebar-icon ",c.icon,"'></span><span id='", c.tId, e.id.SPAN, "'>", d, "</span>");
				b.push('<span class="viewFramework-sidebar-arrow"><i class="base-tool-arrow"><em></em><b></b></i></span>');
        	  } else {
        		//b.push(d);
        		//b.push("<p><span class='viewFramework-sidebar-subHd-icon ",c.icon,"'></span><span>", d, "</span></p>");
        		  b.push("<p><span class='viewFramework-sidebar-subHd-icon'></span><span>", d, "</span></p>");
              }
			  //b.push("<span class=\"viewFramework-sidebar-shape\"></span>");
        ...
        makeDOMNodeMainBefore: function(b, a, c) {
            b.push("<li id='", c.tId, "' class='viewFramework-sidebar-li ", e.className.LEVEL, c.level, "'treenode>")
        },
            ...
            for (k in g)
 			...
 			if(c.isParent) { 
		 		...
		 		if(c.defaultUrl!=""){
			 	 ...
			 	 if(c.level == 0) {
	 				b.push("<div id='", c.tId, e.id.A, "' class='viewFramework-sidebar-linkHd ", cl, c.open ? 'active ' : '', e.className.LEVEL, c.level, "' treeNode", e.id.A, ' onclick="', c.click || "", '" ', f != null && f.length > 0 ? "href='" + f + "'" : "", " target='", i.makeNodeTarget(c), "' style='", l.join(""), "'");
	            		//j.apply(a.view.showTitle, [a.treeId, c], a.view.showTitle) && d && b.push("title='", d.replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "'");
	           		 b.push(">")
			 	 } else {
			 	 	 b.push("<div id='", c.tId, e.id.A, "' class='viewFramework-sidebar-subHd ", cl, c.open ? 'on ' : '', e.className.LEVEL, c.level, "' treeNode", e.id.A, ' onclick="', c.click || "", '" ', f != null && f.length > 0 ? "href='" + f + "'" : "", " target='", i.makeNodeTarget(c), "' style='", l.join(""), "'");
	            		//j.apply(a.view.showTitle, [a.treeId, c], a.view.showTitle) && d && b.push("title='", d.replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "'");
			 	 	 b.push(">");
	           		 //b.push("<span class=\"viewFramework-sidebar-arrow\"><i class=\"base-tool-arrow\"><em></em><b></b></i></span>");
	           		 //b.push("<span class=\"viewFramework-sidebar-shape\"></span>");
			 	 ...
			 	 if(c.defaultUrl!=""){
          			 b.push("<a data-tabid='" + c.tId + "' resId='" + c.resId + "' icon='" + c.icon + "' class='", e.className.LEVEL, c.level, "' treeNode", e.id.A, ' onclick="', c.click || "", '" ', "href='" + c.defaultUrl + "'", " target='", i.makeNodeTarget(c), "' style='", l.join(""), "'");
					 j.apply(a.view.showTitle, [a.treeId, c], a.view.showTitle) && d && b.push("title='", d.replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "'");
	           		 b.push(">");
          		 }
			 	 if(c.level == 0) {
			 	 ...
			 	 b.push("<a data-tabid='" + c.tId + "' id='", c.tId, e.id.A, "' resId='" + c.resId + "' icon='" + c.icon + "' class='", e.className.LEVEL, c.level, "' treeNode", e.id.A, ' onclick="', c.click || "", '" ', "href='" + c.defaultUrl + "'", " target='", i.makeNodeTarget(c), "' style='", l.join(""), "'");
				j.apply(a.view.showTitle, [a.treeId, c], a.view.showTitle) && d && b.push("title='", d.replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "'");
           		 b.push(">")
			 }
        ...
        makeUlHtml: function(b, a, c, d) {
        	...
        	if(a.isParent) {
        		//console.log(d.replace(/<li[^>]+>/g,"").replace(/<\/li>/g,""))
        		if(a.level == 0) { 
					c.push("<div id='", a.tId, e.id.UL, "' class='viewFramework-sidebar-linkBd ", "' style='display:", a.open ? "block" : "none", "'>");
           		} else {
           			c.push("<div id='", a.tId, e.id.UL, "' class='viewFramework-sidebar-subBd ", "' style='display:", a.open ? "block" : "none", "'>");
	           	}
				c.push("<ul id='", a.tId, e.id.UL, "' class='ztree ", e.className.LEVEL, a.level, " ", i.makeUlLineClass(b, a),  "'>");
				c.push(d);
				c.push("</ul>")
				c.push("</div>")

        	} else {
        		 c.push("<ul id='", a.tId, e.id.UL, "' class='ztree ", e.className.LEVEL, a.level, " ", i.makeUlLineClass(b, a), "' style='display:", a.open ? "block" : "none", "'>");
           		 c.push(d);
           		 c.push("</ul>")
        	}
...
(function(m) {
        ...
        view: {
            checkNodeRelation: function(b, a) {
                ...
                if (b.check.chkStyle == c.STYLE) {
                    ...
                    a[l] && (!a[i] || a[i].length == 0 || b.check.chkboxType.Y.indexOf("s") > -1) && e.setSonNodeCheckBox(b, a, !0),
            ...
            setParentNodeCheckBox: function(b, a, c, d) {
                ...
                e.setChkClass(b, l, a),
                b.check.autoCheckTrigger && a != d && b.treeObj.trigger(j.event.CHECK, [null , b.treeId, a]));
                if (a.parentTId) {
                    l = !0;
                    if (!c)
        ...
        data: {
            getRadioCheckedList: function(b) {
                for (var a = f.getRoot(b).radioCheckedList, c = 0, d = a.length; c < d; c++)
                    f.getNodeCache(b, a[c].tId) || (a.splice(c, 1),
                    c--,
                    d--);
                return a
            },
    ...
    f.addInitProxy(function(b) {
        ...
        if (k.eqs(b.type, "mouseover")) {
            if (c.check.enable && k.eqs(a.tagName, "span") && a.getAttribute("treeNode" + j.id.CHECK) !== null )
            ...
            if (c.check.enable && k.eqs(a.tagName, "span") && a.getAttribute("treeNode" + j.id.CHECK) !== null )
                d = k.getNodeMainDom(a).id,
                e = "mouseoutCheck"
        } else if (k.eqs(b.type, "click") && c.check.enable && k.eqs(a.tagName, "span") && a.getAttribute("treeNode" + j.id.CHECK) !== null )
            d = k.getNodeMainDom(a).id,
            e = "checkNode";
        if (d.length > 0)
    ...
    f.addBeforeA(function(b, a, c) {
        b.check.enable && (f.makeChkFlag(b, a),
        c.push("<span ID='", a.tId, j.id.CHECK, "' class='", e.makeChkClass(b, a), "' treeNode", j.id.CHECK, a.nocheck === !0 ? " style='display:none;'" : "", "></span>"))
    });
    f.addZTreeTools(function(b, a) {
        a.checkNode = function(a, c, i, f) {
            ...
            f = !!f,
            (a[g] !== c || i) && !(f && k.apply(this.setting.callback.beforeCheck, [b.treeId, a], !0) == !1) && k.uCanDo(this.setting) && b.check.enable && a.nocheck !== !0))
                a[g] = c,
                c = n(a, j.id.CHECK, b),
...
(function(u) {
    var H = {
      ...
      , x = {
        ...
        onMousedownNode: function(b, a) {
            function c(b) {
                if (A.dragFlag == 0 && Math.abs(M - b.clientX) < e.edit.drag.minMoveSize && Math.abs(N - b.clientY) < e.edit.drag.minMoveSize)
                    return !0;
                var a, c, g, j, k;
                ...
                if (A.dragFlag == 0) {
                    ...
                    c = l.length; a < c; a++) {
                        ...
                        A.dragNodeShowBefore[g.tId] = !0) : A.dragNodeShowBefore[g.tId] = !1
                    }
                    A.dragFlag = 1;
                    t.showHoverDom = !1;
                    h.showIfameMask(e, !0);
                    ...
                    if (l.length > 1) {
                        ...
                        for (a = 0,
                        c = s.length; a < c; a++)
                            if (A.dragNodeShowBefore[s[a].tId] !== void 0 && (g && j > -1 && j + 1 !== a && (g = !1),
                            k.push(s[a]),
                            j = a),
                            l.length === k.length) {
                                l = k;
                    ...
                    c = l.length; a < c; a++)
                        ...
                        f.removeTreeDom(e, g),
                        j = o("<li id='" + g.tId + "_tmp'></li>", e),
                        j.append(o(g, d.id.A, e).clone()),
                        j.css("padding", "0"),
                ...
                if (A.dragFlag == 1) {
                    r && z.attr("id") == b.target.id && v && b.clientX + E.scrollLeft() + 2 > u("#" + v + d.id.A, r).offset().left ? (g = u("#" + v + d.id.A, r),
                    b.target = g.length > 0 ? g.get(0) : b.target) : r && (r.removeClass(d.node.TMPTARGET_TREE),
                    v && u("#" + v + d.id.A, r).removeClass(d.node.TMPTARGET_NODE + "_" + d.move.TYPE_PREV).removeClass(d.node.TMPTARGET_NODE + "_" + H.move.TYPE_NEXT).removeClass(d.node.TMPTARGET_NODE + "_" + H.move.TYPE_INNER));
                    v = r = null ;
                    I = !1;
                    i = e;
                    g = m.getSettings();
                    for (var D in g)
                        if (g[D].treeId && g[D].edit.enable && g[D].treeId != e.treeId && (b.target.id == g[D].treeId || u(b.target).parents("#" + g[D].treeId).length > 0))
                            I = !0,
                            i = g[D];
                    D = E.scrollTop();
                    j = E.scrollLeft();
                    ...
                    if (b.target.id && i.treeObj.find("#" + b.target.id).length > 0) {
                        for (var B = b.target; B && B.tagName && !h.eqs(B.tagName, "li") && B.id != i.treeId; )
                            B = B.parentNode;
                        var R = !0;
                        for (a = 0,
                        c = l.length; a < c; a++)
                        ...
                        if (R && b.target.id && (b.target.id == B.id + d.id.A || u(b.target).parents("#" + B.id + d.id.A).length > 0))
                            r = u(B),
                            v = B.id
                    }
                    g = l[0];
                    if (p && (b.target.id == i.treeId || u(b.target).parents("#" + i.treeId).length > 0)) {
                        if (!r && (b.target.id == i.treeId || q || x || O || P) && (I || !I && g.parentTId))
                            r = i.treeObj;
                    ...
                    if (r && r.attr("id") != i.treeId) {
                        ...
                        if (!g && !a && !F) {
                            ...
                            (J == 1 || b <= J && b >= -0.2) && g ? (a = 1 - z.width(),
                            k = s - z.height() / 2,
                            w = d.move.TYPE_PREV) : (F == 0 || b >= F && b <= 1.2) && a ? (a = 1 - z.width(),
                            k = k == null || y.isParent && y.open ? s + c.height() - z.height() / 2 : k.offset().top - z.height() / 2,
                            w = d.move.TYPE_NEXT) : (a = 5 - z.width(),
                            k = s,
                            w = d.move.TYPE_INNER);
                            z.css({
                                display: "block",
                            ...
                            if (S != v || T != w)
                                K = (new Date).getTime();
                            if (y && y.isParent && w == d.move.TYPE_INNER && (b = !0,
                            window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId !== y.tId ? (clearTimeout(window.zTreeMoveTimer),
                            window.zTreeMoveTargetNodeTId = null ) : window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId === y.tId && (b = !1),
                            b))
                                window.zTreeMoveTimer = setTimeout(function() {
                                    w == d.move.TYPE_INNER && y && y.isParent && !y.open && (new Date).getTime() - K > i.edit.drag.autoOpenTime && h.apply(i.callback.beforeDragOpen, [i.treeId, y], !0) && (f.switchNode(i, y),
                                    i.edit.drag.autoExpandTrigger && i.treeObj.trigger(d.event.EXPAND, [i.treeId, y]))
                                }, i.edit.drag.autoOpenTime + 50),
                                window.zTreeMoveTargetNodeTId = y.tId
                        }
                    } else if (w = d.move.TYPE_INNER,
                    r && h.apply(i.edit.drag.inner, [i.treeId, l, null ], !!i.edit.drag.inner) ? r.addClass(d.node.TMPTARGET_TREE) : r = null ,
                    z.css({
                        display: "none"
                    }),
                    window.zTreeMoveTimer)
            ...
            function n(b) {
                ...
                L.css("cursor", "auto");
                r && (r.removeClass(d.node.TMPTARGET_TREE),
                v && u("#" + v + d.id.A, r).removeClass(d.node.TMPTARGET_NODE + "_" + d.move.TYPE_PREV).removeClass(d.node.TMPTARGET_NODE + "_" + H.move.TYPE_NEXT).removeClass(d.node.TMPTARGET_NODE + "_" + H.move.TYPE_INNER));
                h.showIfameMask(e, !1);
                t.showHoverDom = !0;
                if (A.dragFlag != 0) {
                    ...
                    k = l.length; a < k; a++)
                        j = l[a],
                        j.isParent && A.dragNodeShowBefore[j.tId] && !j.open && (f.expandCollapseNode(e, j, !j.open),
                        delete A.dragNodeShowBefore[j.tId]);
                    C && C.remove();
                    z && z.remove();
                    ...
                    if (r) {
                        ...
                        if (h.apply(e.callback.beforeDrop, [i.treeId, l, q, w, p], !0) == !1)
                            f.selectNodes(x, l);
                        else {
                            var s = p ? h.clone(l) : l;
                            a = function() {
                                if (I) {
                                    ...
                                    if (w == d.move.TYPE_INNER)
                                        f.addNodes(i, q, s);
                                    else if (f.addNodes(i, q.getParentNode(), s),
                                    w == d.move.TYPE_PREV)
                                        for (a = 0,
                                        c = s.length; a < c; a++)
                                    ...
                                    f.addNodes(i, q, s);
                                else if (p && f.addNodes(i, q.getParentNode(), s),
                                w != d.move.TYPE_NEXT)
                                    for (a = 0,
                                    c = s.length; a < c; a++)
                                        f.moveNode(i, q, s[a], w, !1);
            ...
            if (m.isSelectedNode(e, a))
                for (k = 0,
                j = q.length; k < j; k++) {
                    if (q[k].editNameFlag && h.eqs(p.tagName, "input") && p.getAttribute("treeNode" + d.id.INPUT) !== null )
                        return !0;
                    l.push(q[k]);
        ...
        view: {
            ...
            editNode: function(b, a) {
                ...
                if (m.isSelectedNode(b, a) && c.curEditNode == a && a.editNameFlag)
                    ...
                    g.bind("blur", function() {
                        ...
                        f.cancelCurEditNode(b)) : c.keyCode == "27" && f.cancelCurEditNode(b, a[n])
                    }).bind("click", function() {
                        return !1
            ...
            moveNode: function(b, a, c, n, g, k) {
                ...
                if (a != c && (!b.data.keep.leaf || !a || a.isParent || n != d.move.TYPE_INNER)) {
                    ...
                    var p;
                    t ? p = t = b.treeObj : (!k && n == d.move.TYPE_INNER ? f.expandCollapseNode(b, a, !0, !1) : k || f.expandCollapseNode(b, a.getParentNode(), !0, !1),
                    t = o(a, b),
                    p = o(a, d.id.UL, b),
                    t.get(0) && !p.get(0) && (p = [],
                    f.makeUlHtml(b, a, p, ""),
                    ...
                    if (n == d.move.TYPE_INNER) {
                        ...
                        a.isFirstNode && n == d.move.TYPE_PREV ? (j[e].splice(u, 0, c),
                        t = a,
                        t.isFirstNode = !1,
                        c.parentTId = a.parentTId,
                        c.isFirstNode = !0,
                        c.isLastNode = !1) : a.isLastNode && n == d.move.TYPE_NEXT ? (j[e].splice(u + 1, 0, c),
                        t = a,
                        t.isLastNode = !1,
                        c.parentTId = a.parentTId,
                        c.isFirstNode = !1,
                        c.isLastNode = !0) : (n == d.move.TYPE_PREV ? j[e].splice(u, 0, c) : j[e].splice(u + 1, 0, c),
                        c.parentTId = a.parentTId,
                        c.isFirstNode = !1,
                        c.isLastNode = !1);
                    ...
                    n = o(h, d.id.SWITCH, b),
                    e = o(h, d.id.ICON, b),
                    f.replaceSwitchClass(h, n, d.folder.DOCU),
    ...
    m.addZTreeTools(function(b, a) {
        ...
        a.copyNode = function(a, n, g, k) {
            ...
            ,
            h.canAsync(b, a) ? f.asyncNode(b, a, k, n) : n()) : (f.addNodes(b, a.parentNode, [j], k),
            f.moveNode(b, a, j, g, !1, k));
            return j
        }
        ;
        a.editName = function(a) {
            a && a.tId && a === m.getNodeCache(b, a.tId) && (a.parentTId && f.expandCollapseParentNode(b, a.getParentNode(), !0),
            f.editNode(b, a))
        }
        ;
        a.moveNode = function(a, n, g, k) {
            ...
            if (a && !a.isParent && b.data.keep.leaf && g === d.move.TYPE_INNER)
                return null ;
            else if (a && (n.parentTId == a.tId && g == d.move.TYPE_INNER || o(n, b).find("#" + a.tId).length > 0))
                return null ;
            else
                a || (a = null );
