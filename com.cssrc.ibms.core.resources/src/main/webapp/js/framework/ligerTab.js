...
(function ($)
{
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            g.tab.links = $('<div class="l-tab-links viewFramework-tabMenu"><ul style="left: 0px; " class="viewFramework-tabMenu-ul clearFix fl"></ul></div>');
            ...
            {
                var li = $('<li class="viewFramework-tabMenu-li "><a class="viewFramework-tabMenu-txt"></a></li>');
                ...
                if (contentitem.find("iframe").length > 0)
                {
                    ...
                    {
                    	/*iframe属性src的值若为空，loading层将覆盖contentitem层，增加src属性判断--zxg*/
                        if (contentitem.find(".l-tab-loading:first").length == 0 && iframe[0].src!=null&&iframe[0].src!=''){
        ...
        selectTabItem: function (tabid)
        {
            ...
            g.selectedTabId = tabid;
            /*筛选出 g.tab.content中 与  .l-tab-content-item[tabid="选中tabid"] 同级的其他tab节点，并隐藏不显示，不知道为什么这条语句以前是注释的，zxg*/
        ...
        addTabItem: function (options)
        {
            ...
            var tabitem = $("<li class=\"viewFramework-tabMenu-li l-selected\"><a class=\"viewFramework-tabMenu-txt\"></a><div class='l-tab-links-item-close'></div></li>");
            ...
            var title=text;
            if(icon!=null && icon!="" ){
            	title="<img src='"+icon+"' height='18px' width='21px' border='0' style='vertical-align:middle;margin-right:4px;' />" + title;
            }
