...
(function ($)
{
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
                g.tab.menu = $.ligerMenu({ width: 145, items: [
        ...
        selectTabItem: function (tabid)
        {
            ...
            $("> .l-tab-content-item[tabid=" + tabid + "]", g.tab.content).addClass('ligerTabShow').siblings().removeClass('ligerTabShow');
        ...
        addTabItem: function (options)
        {
            ...
            var title=text;
            if(icon!=null && icon!="" ){
            	/*title="<img border='0' style='vertical-align:middle;margin-right:4px;' />" + title;*/
            	title=title;
            }
