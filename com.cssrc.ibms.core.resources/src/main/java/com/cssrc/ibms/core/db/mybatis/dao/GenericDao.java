...
public abstract class GenericDao<E, PK extends Serializable> extends BaseMyBatisDao implements IEntityDao<E, PK>
{
	 ...
	 * @param pb  分页对象 {@link PagingBean pageBean}
	 * @return
	 */
	public List<E> getBySqlKey(String sqlKey,Object params,PagingBean pageBean)
	{
		String statement= getIbatisMapperNamespace() + "." + sqlKey;
	...
	public List<E> getBySqlKey(String sqlKey,QueryFilter queryFilter)
	{
		...
		if(queryFilter.getPagingBean()==null){
			...
			list=getBySqlKey(sqlKey,queryFilter.getFilters(),queryFilter.getPagingBean());
		}
	...
	public void delItemByID(String sqlKey,Object params)
	{
		String delStatement=getIbatisMapperNamespace() + "."+ sqlKey;
		 getSqlSessionTemplate().delete(delStatement, params);
	}
	 ...
	 * @return 返回更新的记录数
	 */
	public int update2(E entity)
	{
		String updStatement=getIbatisMapperNamespace() + ".update2";
		if(entity instanceof BaseModel)
		{
			BaseModel baseModel=((BaseModel) entity);
			baseModel.setUpdatetime(new Date());
	 ...
	 * 返回如：com.ibms.oa.model.role.Role
	 * @return
	 */
	 ...
	 * 
	 */
	public List<E> getList(String statementName,Object params,PagingBean pageBean)
	{
	 ...
	 * by yangbo
	 */
	public List<E> getById(String MapperNamespace,PK primaryKey)
	{
		String statementName = MapperNamespace + ".getById";
		return getSqlSessionTemplate().selectList(statementName, primaryKey);
	}
	 ...
	 * @author liubo
	 */
	public List<E> getByUserId(String MapperNamespace,PK primaryKey)
	{
		String statementName = MapperNamespace + ".getByUserId";
		return getSqlSessionTemplate().selectList(statementName, primaryKey);
	}
