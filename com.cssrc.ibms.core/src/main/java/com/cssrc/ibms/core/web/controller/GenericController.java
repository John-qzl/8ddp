...
public class GenericController
{
        ...
        throws Exception
    {
        ...
        {
            String jspPath =
                "/" + paths[1] + "/" + paths[2] + "/" + paths[3] + StringUtil.makeFirstLetterUpperCase(paths[4])
                    + ".jsp";
        ...
        else
        {
            ...
            throw new Exception("url:[" + requestURI + "] is not in this pattern:[/子系统/包名/表对应实体名/实体操作方法名.do]");
        }
        ...
        throws IOException
    {
        ...
        json.add(obj);
        json.add(queryFilter.getPagingBean());
