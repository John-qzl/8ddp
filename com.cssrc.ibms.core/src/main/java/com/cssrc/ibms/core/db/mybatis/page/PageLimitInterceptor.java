...
import com.cssrc.ibms.core.db.mybatis.help.PropertiesHelper;
...
public class PageLimitInterceptor implements Interceptor{
    private static Logger logger = Logger.getLogger(PageLimitInterceptor.class);
...
//    boolean asyncTotalCount = false;
    ...
    public void setDialect(Dialect dialect) {
        logger.info("dialectClass:"+dialect.getClass().getName());
