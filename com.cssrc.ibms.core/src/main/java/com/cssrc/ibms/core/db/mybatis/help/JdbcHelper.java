package com.cssrc.ibms.core.db.mybatis.help;
...
import com.cssrc.ibms.core.db.mybatis.help.DbCmd.OperatorType;
import com.cssrc.ibms.core.db.mybatis.model.ColumnModel;
...
public class JdbcHelper<T, PK> {
	...
	public synchronized void init(String alias, String className, String url,
		...
		if (!dataSouceMap.containsKey(alias)) {
			...
			TransactionTemplate txTemplate = (TransactionTemplate)AppUtil.getBean("txTemplate");
		 

			Map map = new HashMap();
			map.put("source", source);
			map.put("jdbcTemplate", jdbcTemplate);
			map.put("tansactionTemplate", txTemplate);
	...
	public List<Map<String, Object>> queryForList(String sql,
			Map<String, Object> paramMaps, PagingBean pageBean) {
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public List<T> getPage(PagingBean pageBean, String sql, RowMapper rowMap) {
		int pageSize = pageBean.getPageSize();
		int offset = pageBean.getFirst();
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public T getPage(String sql, ResultSetExtractor<T> rse, PagingBean pageBean,
	...
	public List<T> getPage(int currentPage, int pageSize, String sql,
			Map paraMap, PagingBean pageBean) {
