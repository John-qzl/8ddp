...
public class UniqueIdUtil {
	...
	private static void init() {
		try {
			...
			String path = SysConfConstant.CONF_ROOT + File.separator + "properties"
					+ File.separator + "jdbc.properties";
			String strAdjust = FileOperator.readFromProperties(path,
					"genId.adjust");
			if (strAdjust != null) {
	...
	private static  void getNextIdBlock() {
		...
		try{
			Map<String,Object> map = jdbcTemplate.queryForMap(sql, new Object[] { adjust });
